      ...
      845: () => {
        document.addEventListener("DOMContentLoaded", function () {
          ...
          const e = document.querySelector(".hamburger"),
            ...
            n = document.querySelector(".header__burger-close");
              ...
              typeof (r = function (e) {
                ...
                var t = function (t, n, r) {
                  var i = {
                    ...
                    getRegexMask: function () {
                      for (
                        var e, t, r, i, s, o, l = [], c = 0;
                        c < n.length;
                        c++
                      )
                        (e = a.translation[n.charAt(c)])
                          ? ((t = e.pattern
                              .toString()
                              .replace(/.{1}$|^.{1}/g, "")),
                            (r = e.optional),
                    ...
                    calculateCaretPosition: function (e) {
                      ...
                      if (e !== n) {
                        ...
                        for (p = r - 1; p >= 0 && i.maskDigitPosMap[p]; p--)
                          l++;
                        for (p = r - 1; p >= 0; p--)
                          i.maskDigitPosMap[p] && u++;
                        for (p = s - 1; p >= 0; p--)
                          i.maskDigitPosMapOld[p] && d++;
                        if (r > o) r = 10 * a;
                        else if (s >= r && s !== o) {
                    ...
                    callbacks: function (e) {
                      ...
                      c("onChange", !0 === a, l),
                        ...
                        c("onInvalid", i.invalid.length > 0, [
                          s,
                          e,
                          t,
                          i.invalid,
                  ...
                  (n = "function" == typeof n ? n(i.val(), void 0, t, r) : n),
                    ...
                    (a.remove = function () {
                      var e = i.getCaret();
                      return (
                        a.options.placeholder && t.removeAttr("placeholder"),
                ...
                var n = function () {
                    ...
                    if (
                      ...
                      "true" === n.attr(s + "selectonfocus") &&
                        (i.selectOnFocus = !0),
                      r(n, a, i))
                    )
                      return n.data("mask", new t(this, a, i));
                  },
                  r = function (t, n, r) {
                    r = r || {};
                    var i = e(t).data("mask"),
                ...
                (e.fn.mask = function (n, i) {
                  ...
                  (e.applyDataMask = function (t) {
                    ((t = t || e.jMaskGlobals.maskElements) instanceof e
                      ? t
                      : e(t)
                    )
          ...
          void 0 ===
            (i =
              ...
              typeof (r = function () {
                ...
                var r = { textarea: !0, input: !0, select: !0, button: !0 },
                  i = {
                    move: "mousemove",
                  ...
                  if (l)
                    for (; u--; )
                      if ((s = l[(i = t[u])]))
                        for (o = s.length; o--; )
                          s[o][0] === n &&
                            (e.removeEventListener(i, s[o][1]), s.splice(o, 1));
                }
                ...
                function b(e) {
                  d(document, s.move, e.touchmove),
                    d(document, s.cancel, e.touchend);
                }

                function x(e, n, r, i) {
                  var s = r.pageX - n.pageX,
                    a = r.pageY - n.pageY;
                  s * s + a * a < t * t ||
                ...
                function k(e, t) {
                  var n = t.target,
                    r = t.event,
                    i = t.timer;
                  v(e.changedTouches, r.identifier) &&
                    ((function (e) {
                      d(document, s.move, e.activeTouchmove),
                        d(document, s.end, e.activeTouchend);
                    })(t),
                    C(n, r, i));
                }
                ...
                if (
                  (u(document, "mousedown", function (e) {
                    (function (e) {
                      ...
                      ((function (e) {
                        ...
                        (u(document, i.move, y, e),
                        u(document, i.cancel, _, e)));
                  }),
                  u(document, "touchstart", function (e) {
                    if (!r[e.target.tagName.toLowerCase()]) {
                      ...
                      u(document, s.move, n.touchmove, n),
                        u(document, s.cancel, n.touchend, n);
                    }
                  }),
                  u(document, "movestart", function (e) {
                    if (!e.defaultPrevented && e.moveEnabled) {
                          ...
                          timer: new f(function (e) {
                            (function (e, t, n) {
                              ...
                              (e.distX = t.pageX - e.startX),
                                ...
                                (e.velocityX =
                                  0.3 * e.velocityX + (0.7 * e.deltaX) / r),
                                (e.velocityY =
                                  0.3 * e.velocityY + (0.7 * e.deltaY) / r),
                                (e.pageX = t.pageX),
                                (e.pageY = t.pageY);
                      ...
                      void 0 === e.identifier
                        ? (u(e.target, "click", m),
                          u(document, i.move, T, n),
                          u(document, i.end, S, n))
                        : ((n.activeTouchmove = function (e, t) {
                          ...
                          u(document, s.move, n.activeTouchmove, n),
                          u(document, s.end, n.activeTouchend, n));
                    }
                  }),
                  window.jQuery)
                ) {
                ...
                ? r.apply(t, [])
                : r) || (e.exports = i),
          ((s = jQuery).fn.twentytwenty = function (e) {
            return (
              (e = s.extend(
                {
              ...
              this.each(function () {
                ...
                u.append("<span class='twentytwenty-" + i + "-arrow'></span>"),
                  u.append(
                    "<span class='twentytwenty-" + a + "-arrow'></span>",
                  ),
      ...
      755: function (e, t) {
        ...
        !(function (t, n) {
          ...
          !(function () {
            ...
            try {
              m.apply((s = o.call(N.childNodes)), N.childNodes),
                s[N.childNodes.length].nodeType;
            } catch (e) {
              m = {
                apply: function (e, t) {
                  z.apply(e, o.call(t));
              ...
              if (!r && (le(t), (t = t || l), d)) {
                ...
                if (!(T[e + " "] || (p && p.test(e)))) {
                  if (((f = e), (h = t), 1 === y && (B.test(e) || F.test(e)))) {
                    for (
                      ((h = (W.test(e) && oe(t.parentNode)) || t) == t &&
                        v.scope) ||
                        ((o = t.getAttribute("id"))
                          ? (o = k.escapeSelector(o))
                          : t.setAttribute("id", (o = g))),
                        s = (u = ue(e)).length;
                      s--;

                    )
                      u[s] = (o ? "#" + o : ":scope") + " " + de(u[s]);
                    f = u.join(",");
                  }
                  try {
                ...
                ? ((c = (l = r).documentElement),
                  ...
                  (v.getById = ne(function (e) {
                    return (
                      ...
                      !l.getElementsByName ||
                        !l.getElementsByName(k.expando).length
                    );
                  })),
                  ...
                  (S = function (e, t) {
                    ...
                    return (
                      ...
                      (!v.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e === l || (e.ownerDocument == N && J.contains(N, e))
                          ? -1
                          : t === l ||
                              (t.ownerDocument == N && J.contains(N, t))
                            ? 1
                            : i
                    ...
                    return 1 === r && 0 === i
                      ...
                      : function (t, n, l) {
                          var c,
                            ...
                            p,
                            f,
                            h = s !== a ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                          ...
                          if (m) {
                            if (s) {
                              for (; h; ) {
                                for (d = t; (d = d[h]); )
                                  if (o ? E(d, v) : 1 === d.nodeType) return !1;
                                f = h = "only" === e && !f && "nextSibling";
                              }
                              return !0;
                            }
                            if (
                              ((f = [a ? m.firstChild : m.lastChild]), a && _)
                            ) {
                              for (
                                w =
                                  (p =
                      ...
                      : i.length > 1
                        ? ((r = [e, e, "", n]),
                          t.setFilters.hasOwnProperty(e.toLowerCase())
                            ? te(function (e, t) {
                                for (var r, s = i(e, n), a = s.length; a--; )
                                  e[(r = u.call(e, s[a]))] = !(t[r] = s[a]);
                              })
                            : function (e) {
                                return i(e, 0, r);
                              })
            ...
            function ue(e, n) {
              ...
              for (o = e, l = [], c = t.preFilter; o; ) {
                for (a in ((r && !(i = q.exec(o))) ||
                  (i && (o = o.slice(i[0].length) || o), l.push((s = []))),
                (r = !1),
                (i = F.exec(o)) &&
                  ((r = i.shift()),
                ...
                t.filter))
                  !(i = Y[a].exec(o)) ||
                    (c[a] && !(i = c[a](i))) ||
                    ((r = i.shift()),
                    s.push({ value: r, type: a, matches: i }),
                    (o = o.slice(r.length)));
                if (!r) break;
              }
              ...
              return t.first
                ...
                : function (t, n, l) {
                    ...
                    if (l) {
                      ...
                      for (; (t = t[r]); )
                        if (1 === t.nodeType || a)
                          if (((u = t[g] || (t[g] = {})), i && E(t, i)))
                            t = t[r] || t;
                          else {
                            if ((c = u[s]) && c[0] === y && c[1] === o)
                              return (d[2] = c[2]);
              ...
              return (
                ...
                te(function (s, a, o, l) {
                  var c,
                    ...
                    _ = !e || (!s && t) ? y : he(y, h, e, o, l);
                  if (
                    (n
                      ? n(_, (f = i || (s ? e : g || r) ? [] : a), o, l)
                      : (f = _),
                    r)
                  )
                    for (c = he(f, v), r(c, [], o, l), d = c.length; d--; )
                      (p = c[d]) && (f[v[d]] = !(_[v[d]] = p));
                  if (s) {
                    if (i || e) {
                      if (i) {
                      ...
                      for (d = f.length; d--; )
                        (p = f[d]) &&
                          (c = i ? u.call(s, p) : h[d]) > -1 &&
                          (s[c] = !(a[c] = p));
                    }
                  } else
                    (f = he(f === a ? f.splice(g, f.length) : f)),
                      i ? i(null, a, f, l) : m.apply(a, f);
                })
              );
            }
            ...
            function ge(e, r) {
              ...
              if (!o) {
                for (r || (r = ue(e)), i = r.length; i--; )
                  (o = ve(r[i]))[g] ? s.push(o) : a.push(o);
                (o = x(
                  e,
                  (function (e, r) {
                    var i = r.length > 0,
                      s = e.length > 0,
                      a = function (a, o, c, u, p) {
                        var f,
                          h,
                          v,
                          g = 0,
            ...
            function ye(e, n, r, i) {
              ...
              if (((r = r || []), 1 === p.length)) {
                if (
                  ...
                  if (
                    !(n = (t.find.ID(o.matches[0].replace(U, K), n) || [])[0])
                  )
                    return r;
                  u && (n = n.parentNode),
                ...
                for (
                  s = Y.needsContext.test(e) ? 0 : a.length;
                  s-- && ((o = a[s]), !t.relative[(l = o.type)]);
                  ...
                  if (
                    ...
                    (i = c(
                      ...
                      (W.test(a[0].type) && oe(n.parentNode)) || n,
                    ))
                  ) {
                    if ((a.splice(s, 1), !(e = i.length && de(a))))
          ...
          (k.filter = function (e, t, n) {
            ...
            k.fn.extend({
              ...
              is: function (e) {
                return !!B(
                  this,
                  "string" == typeof e && q.test(e) ? k(e) : e || [],
                  !1,
                ).length;
              },
            });
              ...
              function (e, t) {
                k.fn[e] = function (n, r) {
                  ...
                  return (
                    ...
                    this.length > 1 &&
                      ($[e] || k.uniqueSort(i), Y.test(e) && i.reverse()),
                    this.pushStack(i)
                  );
                };
              },
          ...
          (k.Callbacks = function (e) {
            ...
            k.extend({
                ...
                var t = [
                  ...
                  i = {
                    ...
                    then: function (e, n, i) {
                            ...
                            c = function () {
                              ...
                              if (!(e < s)) {
                                ...
                                (c =
                                  ...
                                  g(c)
                                    ? i
                                      ? c.call(r, a(s, t, W, i), a(s, t, U, i))
                                      : (s++,
                                        c.call(
                                          r,
                                          a(s, t, W, i),
                                          a(s, t, U, i),
                                          a(s, t, W, t.notifyWith),
                                        ))
                                    : (n !== W && ((o = void 0), (l = [r])),
                                      (i || t.resolveWith)(o, l));
                              }
                      ...
                      return k
                        .Deferred(function (r) {
                          t[0][3].add(a(0, r, g(i) ? i : W, r.notifyWith)),
                            t[1][3].add(a(0, r, g(e) ? e : W)),
                            t[2][3].add(a(0, r, g(n) ? n : U));
                        })
                        .promise();
                    },
                    promise: function (e) {
              ...
              when: function (e) {
                ...
                if (
                  t <= 1 &&
                  (K(e, s.done(a(n)).resolve, s.reject, !t),
          ...
          var ee = function (e, t, n, r, i, s, a) {
              var o = 0,
                ...
                c = null == n;
              if ("object" === x(n))
                for (o in ((i = !0), n)) ee(e, t, o, n[o], !0, s, a);
              else if (
                void 0 !== r &&
                ((i = !0),
                g(r) || (a = !0),
                ...
                for (; o < l; o++)
                  t(e[o], n, a ? r : r.call(e[o], o, t(e[o], n)));
          ...
          function xe(e, t) {
            for (var n, r, i = [], s = 0, a = e.length; s < a; s++)
              (r = e[s]).style &&
                ...
                t
                  ? ("none" === n &&
                      ((i[s] = oe.get(r, "display") || null),
                      i[s] || (r.style.display = "")),
                    "" === r.style.display && ye(r) && (i[s] = be(r)))
                  : "none" !== n && ((i[s] = "none"), oe.set(r, "display", n)));
          ...
          (Te = _.createDocumentFragment().appendChild(_.createElement("div"))),
            (Se = _.createElement("input")).setAttribute("type", "radio"),
              ...
              (n =
                void 0 !== e.getElementsByTagName
                  ...
                  : void 0 !== e.querySelectorAll
                    ...
                    : []),
              void 0 === t || (t && E(e, t)) ? k.merge([e], n) : n
            );
          }
          ...
          function De(e, t, n, r, i) {
                ...
                if ("object" === x(s)) k.merge(p, s.nodeType ? [s] : s);
                  ...
                  for (
                    a = a || d.appendChild(t.createElement("div")),
                      ...
                      l = Me[o] || Me._default,
                      a.innerHTML = l[1] + k.htmlPrefilter(s) + l[2],
                      u = l[0];
                    u--;
            ...
            for (d.textContent = "", f = 0; (s = p[f++]); )
              if (r && k.inArray(s, r) > -1) i && i.push(s);
                ...
                ((c = ve(s)),
                (a = Ae(d.appendChild(s), "script")),
                c && Pe(a),
                n)
              )
                for (u = 0; (s = a[u++]); ) Ee.test(s.type || "") && n.push(s);
            return d;
          }
          ...
          function ze(e, t, n, r, i, s) {
            var a, o;
            if ("object" == typeof t) {
              for (o in ("string" != typeof n && ((r = r || n), (n = void 0)),
              t))
                ze(e, o, n, r, t[o], s);
              return e;
            }
          ...
          (k.event = {
            ...
            dispatch: function (e) {
              ...
              if (
                ...
                for (
                  a = k.event.handlers.call(this, l, c), t = 0;
                  ...
                  for (
                    ...
                    (l.rnamespace &&
                      ...
                      void 0 !==
                        (r = (
                          (k.event.special[s.origType] || {}).handle ||
                          s.handler
                        ).apply(i.elem, o)) &&
                        !1 === (l.result = r) &&
            ...
            k.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
              ...
              (k.event.special[e] = {
                setup: function () {
                  ...
                  (r = oe.get(this, t)) || this.addEventListener(t, n),
                    oe.set(this, t, (r || 0) + 1);
                },
                trigger: function () {
                  return Re(this, e), !0;
          ...
          function Ye(e, t) {
            ...
            if (1 === t.nodeType) {
              if (oe.hasData(e) && (o = oe.get(e).events))
                for (i in (oe.remove(t, "handle events"), o))
                  for (n = 0, r = o[i].length; n < r; n++)
                    k.event.add(t, i, o[i][n]);
              le.hasData(e) &&
                ((s = le.access(e)), (a = k.extend({}, s)), le.set(t, a));
            }
          }
          ...
          function Ve(e, t, n, r) {
            ...
            if (
              ...
              for (o = (a = k.map(Ae(i, "script"), Xe)).length; d < p; d++)
                (c = i),
                  d !== f &&
                    ((c = k.clone(c, !0, !0)),
                    o && k.merge(a, Ae(c, "script"))),
                  n.call(e[d], c, d);
              if (o)
                for (
                  u = a[a.length - 1].ownerDocument, k.map(a, He), d = 0;
                  d < o;
                  d++
                )
                  (c = a[d]),
                    Ee.test(c.type || "") &&
                      ...
                      (c.src && "module" !== (c.type || "").toLowerCase()
                        ...
                        : b(c.textContent.replace(Fe, ""), c, u));
            }
            return e;
          }
          ...
          function Ge(e, t, n) {
            for (
              var r, i = t ? k.filter(t, e) : e, s = 0;
              null != (r = i[s]);
              s++
            )
              n || 1 !== r.nodeType || k.cleanData(Ae(r)),
                r.parentNode &&
                  (n && ve(r) && Pe(Ae(r, "script")),
          ...
          k.extend({
            ...
            clone: function (e, t, n) {
              ...
              if (
                ...
                for (a = Ae(o), r = 0, i = (s = Ae(e)).length; r < i; r++)
                  $e(s[r], a[r]);
              if (t)
                if (n)
                  for (
                    s = s || Ae(e), a = a || Ae(o), r = 0, i = s.length;
                    r < i;
                    r++
                  )
                    Ye(s[r], a[r]);
          ...
          function ct(e, t, n, r, i, s) {
            ...
            for (; a < 4; a += 2)
              "margin" === n && (c += k.css(e, n + he[a], !0, i)),
                r
                  ? ("content" === n &&
                      (l -= k.css(e, "padding" + he[a], !0, i)),
                    "margin" !== n &&
                      (l -= k.css(e, "border" + he[a] + "Width", !0, i)))
                  : ((l += k.css(e, "padding" + he[a], !0, i)),
                    "padding" !== n
                      ? (l += k.css(e, "border" + he[a] + "Width", !0, i))
                      : (o += k.css(e, "border" + he[a] + "Width", !0, i)));
            return (
              !r &&
                s >= 0 &&
                (l +=
          ...
          function ut(e, t, n) {
            ...
            return (
              ((!v.boxSizingReliable() && i) ||
                ...
                (s = o in e) && (a = e[o])),
              (a = parseFloat(a) || 0) +
                ct(e, t, n || (i ? "border" : "content"), s, r, a) +
                "px"
            );
          }
          ...
          k.extend({
            ...
            k.each(["height", "width"], function (e, t) {
              k.cssHooks[t] = {
                get: function (e, n, r) {
                  if (n)
                    return !st.test(k.css(e, "display")) ||
                      (e.getClientRects().length &&
                ...
                set: function (e, n, r) {
                  var i,
                    ...
                    o =
                      (a || r) && "border-box" === k.css(e, "boxSizing", !1, s),
                    l = r ? ct(e, t, r, o, s) : 0;
                  return (
                    o &&
                      a &&
          ...
          function wt(e, t, n) {
            ...
            for (
              ...
              if ((r = wt.prefilters[s].call(c, e, u, c.opts)))
                return (
                  g(r.stop) &&
              ...
              function (e, t, n) {
                ...
                if ((l = !k.isEmptyObject(t)) || !k.isEmptyObject(f))
                  for (r in (d &&
                    ...
                    null == (c = v && v.display) && (c = oe.get(e, "display")),
                  ...
                  f))
                    l ||
                      (v
                        ...
                        : (v = oe.access(e, "fxshow", { display: c })),
                      s && (v.hidden = !m),
                      m && xe([e], !0),
                      p.done(function () {
                        for (r in (m || xe([e]), oe.remove(e, "fxshow"), f))
                          k.style(e, r, f[r]);
                      })),
                      (l = _t(m ? v[r] : 0, r, p)),
                      r in v ||
                ...
                return g(e)
                  ...
                  : "boolean" == typeof t && o
                    ...
                    : ((n = Et(e)),
                      this.each(function () {
                        if (o)
                          for (s = k(this), i = 0; i < n.length; i++)
                            (r = n[i]),
                              s.hasClass(r) ? s.removeClass(r) : s.addClass(r);
                        else
                          (void 0 !== e && "boolean" !== a) ||
                            ((r = Ct(this)) && oe.set(this, "__className__", r),
                            this.setAttribute &&
                              this.setAttribute(
                                "class",
                                r || !1 === e
                ...
                select: {
                  ...
                  set: function (e, t) {
                    for (
                      ...
                      ((r = i[a]).selected =
                        k.inArray(k.valHooks.option.get(r), s) > -1) &&
                        (n = !0);
            ...
            trigger: function (e, t, n, i) {
              ...
              if (
                ...
                if (!i && !d.noBubble && !y(n)) {
                  for (
                    l = d.delegateType || m,
                      Dt.test(l + m) || (a = a.parentNode);
                    a;
                    a = a.parentNode
                  )
                    h.push(a), (o = a);
                  o === (n.ownerDocument || _) &&
                    h.push(o.defaultView || o.parentWindow || r);
                }
                ...
                return (
                  ...
                  i ||
                    ...
                    (c &&
                      ...
                      ((o = n[c]) && (n[c] = null),
                      (k.event.triggered = m),
                      e.isPropagationStopped() && p.addEventListener(m, Lt),
                      n[m](),
                      e.isPropagationStopped() && p.removeEventListener(m, Lt),
            ...
            k.extend({
              ...
              ajax: function (e, t) {
                ...
                f.hasContent
                  ...
                  : ((p = f.url.slice(i.length)),
                    f.data &&
                      ...
                      ((i += (Ot.test(i) ? "&" : "?") + f.data), delete f.data),
                    !1 === f.cache &&
                      ((i = i.replace(Bt, "$1")),
                      (p = (Ot.test(i) ? "&" : "?") + "_=" + Pt.guid++ + p)),
                    (f.url = i + p)),
                f.ifModified &&
                  (k.lastModified[i] &&
                ...
                if (
                  ...
                  if (
                    ((T.readyState = 1), u && m.trigger("ajaxSend", [T, f]), c)
                  )
                    return T;
                  f.async &&
                    f.timeout > 0 &&
                ...
                function S(e, t, a, l) {
                  ...
                  c ||
                    ...
                    a &&
                      (w = (function (e, t, n) {
                        for (
                          var r, i, s, a, o = e.contents, l = e.dataTypes;
                          "*" === l[0];
                    ...
                    d
                      ? (f.ifModified &&
                          ((b = T.getResponseHeader("Last-Modified")) &&
                            (k.lastModified[i] = b),
                          (b = T.getResponseHeader("etag")) && (k.etag[i] = b)),
                        204 === e || "HEAD" === f.type
                          ? (x = "nocontent")
                          : 304 === e
                            ? (x = "notmodified")
                    ...
                    (T.statusText = (t || x) + ""),
                    d
                      ? v.resolveWith(h, [p, x, T])
                      : v.rejectWith(h, [T, x, _]),
                    T.statusCode(y),
                    (y = void 0),
                    u &&
          ...
          k.ajaxSetup({
            ...
            k.ajaxPrefilter("json jsonp", function (e, t, n) {
              ...
              if (o || "jsonp" === e.dataTypes[0])
                return (
                  ...
                  n.always(function () {
                    void 0 === s ? k(r).removeProp(i) : (r[i] = s),
            ...
            (k.fn.load = function (e, t, n) {
              var r,
                ...
                o = e.indexOf(" ");
              return (
                o > -1 && ((r = kt(e.slice(o))), (e = e.slice(0, o))),
                g(t)
                  ? ((n = t), (t = void 0))
              ...
              setOffset: function (e, t, n) {
                ...
                "static" === c && (e.style.position = "relative"),
                  ...
                  (s + l).indexOf("auto") > -1
                    ...
                    : ((a = parseFloat(s) || 0), (i = parseFloat(l) || 0)),
            ...
            k.each(["top", "left"], function (e, t) {
              k.cssHooks[t] = et(v.pixelPosition, function (e, n) {
                if (n)
                  return (
                    (n = Je(e, t)), We.test(n) ? k(e).position()[t] + "px" : n
                  );
              });
            }),
    ...
    (() => {
      ...
      function r(e, t, n) {
        e.on("focusout", function () {
          0 !== e.val().length &&
            (n(e) || (e.addClass("active"), t.addClass("active")));
        }),
          e.on("focus", function () {
            0 === e.val().length &&
          ...
          e.on("keyup", function () {
            n(e) && (e.removeClass("active"), t.removeClass("active")),
              0 === e.val().length &&
                (e.removeClass("active"), t.removeClass("active"));
          });
      }
      ...
      t()(document).ready(function () {
        document.querySelector(".header__mobile-nav") &&
          t()(".header__mobile-nav-sub").click(function (e) {
            e.preventDefault(),
              t()(this).hasClass("active")
                ? (t()(this).removeClass("active"),
                  t()(this).siblings(".header__mobile-submenu").slideUp(400))
                : (t()(".header__mobile-nav-sub").removeClass("active"),
                  t()(this).addClass("active"),
                  t()(".header__mobile-submenu").slideUp(400),
                  t()(this).siblings(".header__mobile-submenu").slideDown(400));
          });
      }),
        document.addEventListener("DOMContentLoaded", function () {
          document.querySelector(".form") &&
            (t()(".feedback__tel-block")
              .find(".form__tel-input")
              .mask("(000) 000-00-00"),
            t()("#feedback").submit(function (e) {
              return (
                e.preventDefault(),
                !!(function () {
                  const e = i(
                      t()(".feedback__name-block").children(".form__input"),
                      t()(".feedback__name-block").children(".form__error-msg"),
                      o,
                    ),
                    n = i(
                      t()(".feedback__email-block").children(".form__input"),
                      t()(".feedback__email-block").children(
                        ".form__error-msg",
                      ),
                      a,
                    ),
                    r = i(
                      t()(".feedback__comment-block").children(".form__input"),
                      t()(".feedback__comment-block").children(
                        ".form__error-msg",
                      ),
                      l,
                    );
              ...
              return (
                ...
                !!(function () {
                  const e = i(
                    ...
                    r = i(
                      t()(".feedback__resume-block").find(
                        ".form__input_resume",
                      ),
                      t()(".feedback__resume-block").children(
                        ".form__error-msg",
                      ),
                      s,
                    );
            ...
            document.querySelector("#feedback") &&
              (function () {
                ...
                r(
                  t()(".feedback__email-block").children(".form__input"),
                  t()(".feedback__email-block").children(".form__error-msg"),
                  a,
                );
                r(
                  t()(".feedback__comment-block").children(".form__input"),
                  t()(".feedback__comment-block").children(".form__error-msg"),
                  l,
                );
              })(),
            document.querySelector("#form-resume") &&
              (function () {
                r(
                  t()(".feedback__name-block").children(".form__input"),
                  t()(".feedback__name-block").children(".form__error-msg"),
                ...
                const e = t()(".feedback__resume-block").find(
                    ".form__input_resume",
                  ),
                  n = t()(".feedback__resume-block").children(
                    ".form__error-msg",
                  );
                var i, s;
                (s = n),
                  (i = e).on("change", function () {
                    ...
                    e &&
                      ...
                      t()(".feedback__resume-block")
                        .find(".feedback__resume-file")
                        .html(e.name),
                      t()(".feedback__resume-block")
                        .find(".feedback__resume-label")
                        .html(""));
                  });
              })());
        }),
        document.addEventListener("DOMContentLoaded", function () {
          document.querySelector(".form") &&
            t()(".tel-code-open").click(function () {
              screen.width > 769
                ? t()(this).hasClass("active")
                  ? (t()(this).removeClass("active"),
                    t()(".form__code-drop").slideUp(300))
                  : (t()(this).addClass("active"),
                    t()(".form__code-drop").slideDown(300))
                : (t()(".modal-code").addClass("active"),
                  t()(document.body).css("overflow", "hidden"));
            });
        }),
        document.addEventListener("DOMContentLoaded", function () {
          document.querySelector(".form") &&
            (t()(".form__code-list").click(function (e) {
              if (!e.target.classList.contains("form__code-list")) {
                const n = e.target,
                  r = n.classList.contains("form__code-item")
                    ? n.children[0].textContent
                    : n.textContent;
                t()(".form__code-input").val(r),
                  screen.width > 769
                    ? (t()(".tel-code-open").removeClass("active"),
                      t()(".form__code-drop").slideUp(300))
                    : t()(".modal-code").removeClass("active");
              }
            }),
            t()(".modal-code")
              .find(".modal__close")
              .click(function () {
                t()(".modal-code").removeClass("active"),
                  t()(document.body).css("overflow", "auto");
              }),
            document.addEventListener("click", (e) => {
              screen.width < 768 ||
                (0 === t()(".form__code-box").find(e.target).length &&
                  (t()(".tel-code-open").removeClass("active"),
                  t()(".form__code-drop").slideUp(300)));
            }),
            ...
            t()(".form__code-search").on("keyup", function (e) {
              !(function (e) {
                if (isNaN(Number(e))) {
                  const n =
                    t()(".form__code-list").children(".form__code-item");
                  if ("" === e) {
                  ...
                  for (let t = 0; t < n.length; t++)
                    n[t].textContent.toLowerCase().includes(e.toLowerCase())
                      ? n[t].classList.remove("hidden")
                      : n[t].classList.add("hidden");
                } else {
                  const n =
                      t()(".form__code-list").children(".form__code-item"),
                    r = t()(".form__code-list").find("span");
                  if ("" === e) {
                  ...
                  for (let t = 0; t < r.length; t++)
                    r[t].textContent.toLowerCase().includes(e.toLowerCase())
                      ? n[t].classList.remove("hidden")
                      : n[t].classList.add("hidden");
                }
              })(e.target.value);
        ...
        t()(document).ready(function () {
          ...
          const e = document.querySelector(".modal-person"),
            n = document.querySelector(".modal"),
            r = document.querySelector(".modal__close"),
            i = () => {
              e.classList.remove("active");
            };
          t()("body").on("click", ".people-open-modal", function () {
            ((n) => {
              const r = n.attr("data-people"),
                i = n.children(".people__item-photo-box");
              let s;
              if (i.children(".people__item-img").length > 0)
                t()(".modal-person__img-box").removeClass("modal-person_man"),
                  t()(".modal-person__img-box").removeClass(
                    "modal-person_woman",
                  ),
                  (s = i.children(".people__item-img")[0].src),
                  t()(".modal-person__img").attr("src", s);
              else {
                const e = "man" == r ? "woman" : "man";
                t()(".modal-person__img-box").removeClass(`modal-person_${e}`),
                  t()(".modal-person__img-box").addClass(`modal-person_${r}`);
              }
        ...
        t()(document).ready(function () {
          ...
          const e = document.querySelector(".modal-thanks"),
            n = t()(".modal-thanks").find(".modal__close"),
            r = () => {
              e.classList.remove("active");
            };
          n.click(function () {
      ...
      var N = {
        updateSize: function () {
          ...
          (t =
            ...
            (0 === t && e.isHorizontal()) ||
              ...
              ((t =
                t -
                parseInt(S(r, "padding-left") || 0, 10) -
                parseInt(S(r, "padding-right") || 0, 10)),
              (n =
                n -
                parseInt(S(r, "padding-top") || 0, 10) -
                parseInt(S(r, "padding-bottom") || 0, 10)),
              Number.isNaN(t) && (t = 0),
              Number.isNaN(n) && (n = 0),
              Object.assign(e, {
                width: t,
        ...
        updateSlides: function () {
          ...
          const n = e.params,
            ...
            u = b(i, `.${e.params.slideClass}, swiper-slide`),
          ...
          for (let r = 0; r < d; r += 1) {
            ...
            if (
              ((M = 0),
              u[r] && (i = u[r]),
              E && e.grid.updateSlide(r, i, u),
              !u[r] || "none" !== S(i, "display"))
            ) {
              if ("auto" === n.slidesPerView) {
                ...
                if (
                  ...
                  M = e.isHorizontal() ? C(i, "width", !0) : C(i, "height", !0);
                else {
                  const e = t(s, "width"),
                    n = t(s, "padding-left"),
                    r = t(s, "padding-right"),
                ...
                (M = (s - (n.slidesPerView - 1) * w) / n.slidesPerView),
                  n.roundLengths && (M = Math.floor(M)),
                  u[r] && (u[r].style[e.getDirectionLabel("width")] = `${M}px`);
          ...
          if (
            ...
            n.setWrapperSize &&
              (r.style[e.getDirectionLabel("width")] =
                `${e.virtualSize + w}px`),
            E && e.grid.updateWrapperSize(M, p),
            !n.centeredSlides)
          ) {
            const t = [];
          ...
          if (
            ...
            _(r, "--swiper-centered-offset-before", -p[0] + "px"),
              _(
                r,
        ...
        updateSlidesClasses: function () {
          const e = this,
            ...
            o = (e) => b(r, `.${n.slideClass}${e}, swiper-slide${e}`)[0];
          let l, c, u;
          if (
            (t.forEach((e) => {
              e.classList.remove(
        ...
        updateActiveIndex: function (e) {
              ...
              (c = (function (e) {
                ...
                for (let e = 0; e < t.length; e += 1)
                  void 0 !== t[e + 1]
                    ...
                    : r >= t[e] && (i = e);
                return (
                  n.normalizeSlideIndex && (i < 0 || void 0 === i) && (i = 0), i
                );
              })(t)),
            r.indexOf(n) >= 0)
          )
          ...
          let p;
          if (t.virtual && i.virtual.enabled && i.loop) p = u(c);
          else if (d) {
              ...
              (i = parseInt(
                ...
                t.centeredSlides
                  ? s < e.loopedSlides - r / 2 ||
                    ...
                    ? (e.loopFix(),
                      (s = e.getSlideIndex(
                        b(n, `${a}[data-swiper-slide-index="${i}"]`)[0],
                      )),
                      m(() => {
                        e.slideTo(s);
                      }))
        ...
        j = {
          loopCreate: function (e) {
            ...
            const i = () => {
              ...
              c = (e) => {
                for (let r = 0; r < e; r += 1) {
                  const e = t.isElement
                    ? T("swiper-slide", [n.slideBlankClass])
                    : T("div", [n.slideClass, n.slideBlankClass]);
                  t.slidesEl.append(e);
                }
              };
            o
          ...
          loopFix: function (e) {
            ...
            const E = y ? Math.ceil(c.length / f.grid.rows) : c.length,
              M =
                (y ? c[s].column : s) + (h && void 0 === i ? -m / 2 + 0.5 : 0);
            if (M < g) {
              k = Math.max(g - M, v);
                ...
                ? l.controller.control.forEach((t) => {
                    !t.destroyed &&
                      ...
                      t.loopFix({
                        ...e,
                        slideTo:
                          t.params.slidesPerView === f.slidesPerView && n,
                      });
                  })
      ...
      function F(e) {
        ...
        if ("touchstart" === r.type)
          return void q(t, r, r.targetTouches[0].pageX);
        ...
        l.matches(i.focusableElements) &&
          ((y = !1), "SELECT" === l.nodeName && (i.isTouched = !1)),
          n.activeElement &&
      ...
      function X(e) {
        ...
        for (
          ...
          void 0 !== l[e + t]
            ? p >= l[e] && p < l[e + t] && ((f = e), (h = l[e + t] - l[e]))
            : p >= l[e] && ((f = e), (h = l[l.length - 1] - l[l.length - 2]));
        }
        let g = null,
          y = null;
        s.rewind &&
        ...
        if (d > s.longSwipesMs) {
          ...
          "next" === t.swipeDirection &&
            (_ >= s.longSwipesRatio
              ? t.slideTo(s.rewind && t.isEnd ? g : f + w)
              : t.slideTo(f)),
            "prev" === t.swipeDirection &&
              (_ > 1 - s.longSwipesRatio
                ? t.slideTo(f + w)
                : null !== y && _ < 0 && Math.abs(_) > s.longSwipesRatio
                  ? t.slideTo(y)
                  : t.slideTo(f));
        } else {
          ...
          (i.target !== t.navigation.nextEl && i.target !== t.navigation.prevEl)
            ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : f + w),
              "prev" === t.swipeDirection && t.slideTo(null !== y ? y : f))
      ...
      class ee {
        ...
        getSlideIndex(e) {
          const { slidesEl: t, params: n } = this,
            r = k(b(t, `.${n.slideClass}, swiper-slide`)[0]);
          return k(e) - r;
        }
        ...
        mount(e) {
          ...
          return (
            !i &&
              ...
              ((i = T("div", t.params.wrapperClass)),
              n.append(i),
              b(n, `.${t.params.slideClass}`).forEach((e) => {
                i.append(e);
              })),
            Object.assign(t, {
              el: n,
              ...
              rtlTranslate:
                ...
                ("rtl" === n.dir.toLowerCase() || "rtl" === S(n, "direction")),
        ...
        function p(e) {
          return !(
            ...
            (t.params.mousewheel.thresholdTime &&
              v() - l < t.params.mousewheel.thresholdTime) ||
            (!(e.delta >= 6 && v() - l < 60) &&
              (e.direction < 0
      ...
      var re,
        ie =
          ((re = document.getElementsByTagName("html")[0]),
          function () {
      ...
      t()(document).ready(function () {
        ...
        t()(".approach__twenty").twentytwenty({
          default_offset_pct: 0.5,
          move_with_handle_only: !0,
          no_overlay: !0,
        });
            ...
            function (n) {
              n.forEach((n) => {
                n.isIntersecting &&
                  ...
                  t()(".approach__preview-box").addClass("hidden"),
                  e.unobserve(n.target));
              });
            },
            { threshold: [0.9] },
          ),
          n = document.querySelector(".approach__img-card_over");
        e.observe(n);
      }),
        t()(document).ready(function () {
          if (!document.querySelector(".services")) return;
          new ee(".services__slider", {
            modules: [ne],
            slidesPerView: "1.1",
            spaceBetween: "2%",
            grabCursor: !0,
            ...
            breakpoints: { 768: { slidesPerView: "3.4", spaceBetween: "2%" } },
          });
          const e = {
              threshold: [0],
            ...
            n = document.querySelectorAll(".services__swiper-slide");
          n.forEach((e) => {
            e.classList.add("hidden"), t.observe(e);
          });
          const r = document.querySelector(".services__swiper-btn-next"),
            i = new MutationObserver((e) => {
              for (let t of e)
                if ("attributes" === t.type) {
                  if ("class" !== t.attributeName) return;
                  t.target.classList.contains("swiper-button-disabled")
                    ? n.forEach((e) => {
        ...
        t()(document).ready(function () {
          ...
          let n = "0",
            r = new Map();
          const i = new Map(),
            s = t()('.advantages__display-title[data-advantages="0"]').css(
              "height",
            );
          t()(".advantages__display-title-list").css("height", s);
          const a = t()('.advantages__display-text[data-advantages="0"]').css(
            "height",
          );
          t()(".advantages__display-text-list").css("height", a),
            e.forEach((e, s) => {
              const a = e.getAttribute("data-advantages");
              r.set(
                e,
                t()(`.advantages__display-title[data-advantages="${a}"]`),
              ),
                i.set(
                  e,
                  t()(`.advantages__display-text[data-advantages="${a}"]`),
                ),
                e.addEventListener("click", (s) => {
                  let dataAdvantages = e.getAttribute("data-advantages");
                  document
                    .querySelectorAll(".advantages__more-link")
                    .forEach((elem) => {
                  ...
                  ((e, s) => {
                    t()(
                      `.advantages__list-item[data-advantages="${n}"]`,
                    )[0].classList.remove("active"),
                      e.classList.add("active"),
                      t()(
                        `.advantages__display-title[data-advantages="${n}"]`,
                      )[0].classList.remove("active"),
                      e.classList.add("active"),
                      t()(
                        `.advantages__display-text[data-advantages="${n}"]`,
                      )[0].classList.remove("active"),
                      e.classList.add("active");
                    const a = r.get(e),
                      o = i.get(e);
                    ...
                    t()(".advantages__display-title-list").css(
                      "height",
                      `${se(l)}rem`,
                    );
                    const c = o.css("height");
                    t()(".advantages__display-text-list").css(
                      "height",
                      `${se(c)}rem`,
                    ),
                      (n = s);
        ...
        t()(document).ready(function () {
          document.querySelector(".advantages") &&
            t()(".advantages__item-title").click(function (e) {
              e.preventDefault(),
                t()(this).hasClass("active")
                  ? (t()(this).removeClass("active"),
                    t()(this).siblings(".advantages__item-info").slideUp(400))
                  : (t()(".advantages__item-title").removeClass("active"),
                    t()(this).addClass("active"),
                    t()(".advantages__item-info").slideUp(400),
                    t()(this)
                      .siblings(".advantages__item-info")
                      .slideDown(400));
            });
        }),
        t()(document).ready(function () {
          ...
          const graphPrecentList = document.querySelectorAll(
            ".plan__graph-percent",
          );
        ...
        t()(document).ready(function () {
          document.querySelector(".news__slider") &&
            new ee(".news__slider", {
              modules: [ne],
              slidesPerView: "1.1",
              speed: 400,
              ...
              breakpoints: {
                768: { slidesPerView: 6, spaceBetween: 30, centeredSlides: !0 },
              },
            });
        }),
        t()(document).ready(function () {
          document.querySelector(".approach__view-all") &&
            t()(".approach__view-all").click(function () {
              t()(this).hasClass("hide")
                ? (t()(".approach__text").removeClass("display"),
                  t()(this).removeClass("hide"),
                  t()(this).html("View all"))
                : (t()(".approach__text").addClass("display"),
                  t()(this).addClass("hide"),
                  t()(this).html("Hide"));
            });
        }),
        t()(document).ready(function () {
          document.querySelector(".plan__view-all") &&
            t()(".plan__view-all").click(function () {
              t()(this).hasClass("hide")
                ? (t()(".plan__text").removeClass("display"),
                  t()(this).removeClass("hide"),
                  t()(this).html("View all"))
                : (t()(".plan__text").addClass("display"),
                  t()(this).addClass("hide"),
                  t()(this).html("Hide"));
            });
        }),
        t()(document).ready(function () {
          document.querySelector(".news-list") &&
            t()(".news-list__view-all").click(function () {
      ...
      var le,
        ...
        ht = function (e) {
          ...
          for (n = e.length; n--; )
            (e[n] && (e[n]._gsap || (e[n]._gsap = new Xn(e[n], t)))) ||
              e.splice(n, 1);
          return e;
        },
        mt = function (e) {
        ...
        Tt = function (e, t, n, r) {
          ot.length && !ce && xt(),
            e.render(t, n, r || (ce && t < 0 && (e._initted || e._startAt))),
            ot.length && !ce && xt();
        },
        St = function (e) {
          var t = parseFloat(e);
        ...
        Rt = function (e) {
          return e._repeat
            ? jt(e._tTime, (e = e.duration() + e._rDelay)) * e
            : 0;
        },
        jt = function (e, t) {
        ...
        Xt = function (e, t) {
          ...
          if (
            ((t._time ||
              ...
              ((n = qt(e.rawTime(), t)),
              (!t._dur || en(0, t.totalDuration(), n) - t._tTime > Ce) &&
                t.render(n, !0)),
        ...
        Ht = function (e, t, n, r) {
          return (
            t.parent && Lt(t),
            (t._start = _t(
              (Ne(n) ? n : n || e !== de ? Qt(e, n, t) : e._time) + t._delay,
            )),
            (t._end = _t(
              t._start + (t.totalDuration() / Math.abs(t.timeScale()) || 0),
            )),
            Ot(e, t, "_first", "_last", e._sort ? "_start" : 0),
            Gt(t) || (e._recent = t),
            r || Xt(e, t),
            e._ts < 0 && Bt(e, e._tTime),
            e
          );
        },
        Yt = function (e, t) {
          return (
            (Ke.ScrollTrigger || Je("scrollTrigger", t)) &&
        ...
        Wt = function (e, t, n, r) {
          ...
          return (
            ...
            (e._tDur = i
              ? i < 0
                ? 1e10
                : _t(s * (i + 1) + e._rDelay * i)
              : s),
            a > 0 && !r && Bt(e, (e._tTime = e._tDur * a)),
            e.parent && Ft(e),
            n || It(e.parent, e),
            e
          );
        ...
        Kt = { _start: 0, endTime: nt, totalDuration: nt },
        Qt = function e(t, n, r) {
          var i,
            s,
            a,
            o = t.labels,
            l = t._recent || Kt,
            c = t.duration() >= ke ? l.endTime(!1) : t._dur;
          return Le(n) && (isNaN(n) || n in o)
            ? ((s = n.charAt(0)),
              (a = "%" === n.substr(-1)),
              (i = n.indexOf("=")),
              "<" === s || ">" === s
                ...
                : i < 0
                  ...
                  : ((s = parseFloat(n.charAt(i - 1) + n.substr(i + 1))),
                    a &&
                      r &&
                      (s = (s / 100) * (Xe(r) ? r[0] : r).totalDuration()),
        ...
        Zt = function (e, t, n) {
          ...
          if ((s && (o.duration = t[1]), (o.parent = n), e)) {
            for (r = o, i = n; i && !("immediateRender" in r); )
              (r = i.vars.defaults || {}), (i = je(i.vars.inherit) && i.parent);
            (o.immediateRender = je(r.immediateRender)),
              ...
              ? Xe(e)
                ? (function (e, t, n) {
                    return (
                      ...
                      e.forEach(function (e) {
                        var r;
                        return (Le(e) && !t) || rn(e, 1)
                          ? (r = n).push.apply(r, sn(e))
                          : n.push(e);
                      }) || n
                    );
                  })(e, n)
                : rn(e)
                  ...
                  : e
                    ? [e]
                    : []
              : nn.call((t || he).querySelectorAll(e), 0);
        },
        an = function (e) {
          return (
            (e = sn(e)[0] || et("Invalid scope") || {}),
            function (t) {
              ...
              return sn(
                ...
                n.querySelectorAll
                  ? n
                  : n === e
                    ? et("Invalid scope") || he.createElement("div")
                    : e,
              );
            }
          );
            ...
            function (e, a, d) {
              ...
              if (!x) {
                if (!(w = "auto" === t.grid ? 0 : (t.grid || [1, ke])[1])) {
                  for (
                    y = -ke;
                    y < (y = d[w++].getBoundingClientRect().left) && w < b;
                ...
                for (
                  x = s[b] = [],
                    p = o ? Math.min(w, b) * c - 0.5 : r % w,
                    f = w === ke ? 0 : o ? (b * u) / w - 0.5 : (r / w) | 0,
                    y = 0,
                    _ = ke,
                    g = 0;
                  g < b;
                ...
                "random" === r && on(x),
                  ...
                  (x.v = b =
                    (parseFloat(t.amount) ||
                      ...
                      0) * ("edges" === r ? -1 : 1)),
                  (x.b = b < 0 ? i - b : i),
                  (x.u = tn(t.amount || t.each) || 0),
                  (n = n && b < 0 ? Nn(n) : n);
              }
              return (
                (b = (x[e] - x.min) / x.max || 0),
                _t(x.b + (n ? n(b) : b) * x.v) + x.u
              );
            }
          );
        },
        ...
        fn = function (e) {
          for (var t, n, r, i, s = 0, a = ""; ~(t = e.indexOf("random(", s)); )
            (r = e.indexOf(")", t)),
              (i = "[" === e.charAt(t + 7)),
              (n = e.substr(t + 7, r - t - 7).match(i ? We : He)),
              (a +=
                e.substr(s, t - s) +
                dn(i ? n : +n[0], i ? 0 : +n[1], +n[2] || 1e-5)),
              (s = r + 1);
        ...
        gn = function (e) {
          return (
            Lt(e),
            e.scrollTrigger && e.scrollTrigger.kill(!!ce),
            e.progress() < 1 && vn(e, "onInterrupt"),
            e
          );
        },
        yn = [],
        _n = function (e) {
          if (qe() && e) {
            ...
            if ((Pn(), e !== r)) {
              if (ct[t]) return;
              Ct(r, Ct(At(e, i), s)),
                Et(r.prototype, Et(i, At(e, s))),
                (ct[(r.prop = t)] = r),
                e.targetTest && (pt.push(r), (at[t] = 1)),
                (t =
                  ("css" === t
                    ? "CSS"
        ...
        Tn = function (e, t, n) {
          var r,
            ...
            d,
            p,
            f = e ? (Ne(e) ? [e >> 16, (e >> 8) & wn, e & wn] : 0) : bn.black;
          if (!f) {
            if (
              ("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), bn[e])
            )
              f = bn[e];
            else if ("#" === e.charAt(0)) {
              if (
              ...
              if (((f = p = e.match(He)), t)) {
                if (~e.indexOf("="))
                  return (f = e.match(Ye)), n && f.length < 4 && (f[3] = 1), f;
              } else
                (a = (+f[0] % 360) / 360),
                  (o = +f[1] / 100),
                  (r =
                  ...
                  (f[1] = xn(a, r, i)),
                  (f[2] = xn(a - 1 / 3, r, i));
            else f = e.match(He) || bn.transparent;
            f = f.map(Number);
          }
          return (
            t &&
        ...
        kn = function (e, t, n) {
          ...
          if (
            ...
            n && ((s = Sn(e)), (r = n.c).join(o) !== s.c.join(o)))
          )
            for (a = (i = e.replace(Cn, "1").split($e)).length - 1; u < a; u++)
              o +=
                i[u] +
                (~r.indexOf(u)
                  ? l.shift() || c + "0,0,0,0)"
          ...
          if (!i)
            for (a = (i = e.split(Cn)).length - 1; u < a; u++) o += i[u] + l[u];
          return o + i[a];
        },
        Cn = (function () {
          var e,
          ...
          var e,
            ...
            h = function n(h) {
              ...
              if (
                ...
                for (s = 0; s < f.length; s++) f[s](g, i, y, h);
            };
          return (r = {
            time: 0,
            frame: 0,
            ...
            wake: function () {
              me &&
                (!fe &&
                  ...
                  (he = pe.document || {}),
                  (Ke.gsap = Mr),
                  (pe.gsapVersions || (pe.gsapVersions = [])).push(Mr.version),
                  Ze(Qe || pe.GreenSockGlobals || (!pe.gsap && pe) || {}),
                  (n = pe.requestAnimationFrame),
                  yn.forEach(_n)),
                e && r.sleep(),
                (t =
                  n ||
            ...
            sleep: function () {
              (n ? pe.cancelAnimationFrame : clearTimeout)(e),
                (ye = 0),
                (t = nt);
            },
        ...
        In = function (e) {
          for (
            ...
            (n = s[o]),
              ...
              (r = n.substr(0, t)),
              (i[a] = isNaN(r) ? r.replace(Ln, "").trim() : +r),
              (a = n.substr(t + 1).trim());
          return i;
        },
        Nn = function (e) {
        ...
        jn = function (e, t, n, r) {
          ...
          return (
            gt(e, function (e) {
              for (var t in ((On[e] = Ke[e] = s),
              (On[(i = e.toLowerCase())] = n),
              s))
                On[
                  i +
                    ("easeIn" === t
        ...
        Fn = function e(t, n, r) {
          var i = n >= 1 ? n : 1,
            ...
            a = (s / Ee) * (Math.asin(1 / i) || 0),
            o = function (e) {
              return 1 === e
                ? 1
                : i * Math.pow(2, -10 * e) * De((e - a) * s) + 1;
            },
            l =
              "out" === t
                ? o
          ...
          (xe = function (e) {
            return e < be
              ...
              : e < 0.7272727272727273
                ? _e * Math.pow(e - 1.5 / we, 2) + 0.75
                : e < 0.9090909090909092
                  ? _e * (e -= 2.25 / we) * e + 0.9375
                  : _e * Math.pow(e - 2.625 / we, 2) + 0.984375;
          }),
        ),
        jn("Expo", function (e) {
          ...
          Ke.SteppedEase =
            {
              config: function (e, t) {
                ...
                var n = 1 / e,
                  ...
                  i = t ? 1 : 0;
                return function (e) {
                  return (((r * en(0, 0.99999999, e)) | 0) + i) * n;
                };
              },
            }),
        (Se.ease = On["quad.out"]),
          ...
          return (
            ...
            (t.totalTime = function (e, t) {
              ...
              if (n && n.smoothChildTiming && this._ts) {
                for (
                  Bt(this, e), !n._dp || n.parent || Xt(n, this);
                  n && n.parent;
              ...
              return (
                (this._tTime !== e ||
                  ...
                  (this._ts || (this._pTime = e), Tt(this, e, t)),
                this
              );
            }),
            (t.time = function (e, t) {
            ...
            (t.timeScale = function (e, t) {
              ...
              return (
                ...
                this.totalTime(
                  en(-Math.abs(this._delay), this._tDur, n),
                  !1 !== t,
                ),
                Ft(this),
                (function (e) {
            ...
            (t.endTime = function (e) {
              return (
                this._start +
                (je(e) ? this.totalDuration() : this.duration()) /
                  Math.abs(this._ts || 1)
              );
            }),
            ...
            (t.repeat = function (e) {
              return arguments.length
                ? ((this._repeat = e === 1 / 0 ? -2 : e), Ut(this))
                : -2 === this._repeat
                  ? 1 / 0
                  : this._repeat;
            }),
      ...
      var Yn = (function (e) {
        function t(t, n) {
          ...
          return (
            ...
            (r._sort = je(t.sortChildren)),
            de && Ht(t.parent || de, ae(r), n),
            t.reversed && r.reverse(),
            t.paused && r.paused(!0),
            t.scrollTrigger && Yt(ae(r), t.scrollTrigger),
            r
          );
        }
        ...
        return (
          ...
          (n.staggerFrom = function (e, t, n, r, i, s, a) {
            return (
              (n.runBackwards = 1),
              (Pt(n).immediateRender = je(n.immediateRender)),
          ...
          (n.staggerFromTo = function (e, t, n, r, i, s, a, o) {
            return (
              (r.startAt = n),
              (Pt(r).immediateRender = je(r.immediateRender)),
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    (m = w ? 0 : y % g ? g : y),
                    (this._lock = 1),
                    (this.render(m || (h ? 0 : _t(a * o)), t, !g)._lock = 0),
                    (this._tTime = y),
                    !t && this.parent && vn(this, "onRepeat"),
              ...
              if (
                ...
                this._initted ||
                  ...
                  (this._zTime = e),
                  (m = 0)),
                !m && r && !t && !a && (vn(this, "onStart"), this._tTime !== y))
              )
                return this;
              if (r >= m && e >= 0)
                for (i = this._first; i; ) {
              ...
              this._onUpdate && !t && vn(this, "onUpdate", !0),
          ...
          (n.removePause = function (e) {
            var t = this._first;
            for (e = Qt(this, e); t; )
              t._start === e && "isPause" === t.data && Lt(t), (t = t._next);
          }),
          ...
          (n.getTweensOf = function (e, t) {
            for (var n, r = [], i = sn(e), s = this._first, a = Ne(t); s; )
              s instanceof tr
                ? bt(s._targets, i) &&
                  (a
                    ? (!$n || (s._initted && s._ts)) &&
                ...
                Ct(
                  {
                    ...
                    onStart: function () {
                      if ((r.pause(), !n)) {
                        ...
                        u._dur !== e && Wt(u, e, 0, 1).render(u._time, !0, !0),
                          (n = 1);
                      }
                      o && o.apply(u, l || []);
                    },
            ...
            if (s._dirty) {
              for (r = s.parent; a; )
                (t = a._prev),
                  ...
                  (a = t);
              Wt(s, s === de && s._time > i ? s._time : i, 1, 1),
                (s._dirty = 0);
            }
            return s._tDur;
          }),
          (t.updateRoot = function (e) {
            if (
              (de._ts && (Tt(de, qt(e, de)), (ve = An.frame)), An.frame >= dt)
            ) {
              dt += Te.autoSleep || 120;
              var t = de._first;
      ...
      var $n,
        ...
        Gn = function (e, t, n, r, i, s, a) {
          var o,
            ...
            f,
            h,
            m = new mr(this._pt, e, t, 0, 1, cr, null, i),
            v = 0,
            g = 0;
          for (
            m.b = n,
        ...
        Wn = function (e, t, n, r, i, s, a, o, l, c) {
          ...
          if (
            ...
            return isNaN(p * r) || "" === r
              ? (!d && !(t in e) && Je(t, r),
                Gn.call(this, e, t, p, r, f, o || Te.stringFilter, l))
              : ((u = new mr(
                  this._pt,
                  e,
                  t,
        ...
        Un = function (e, t, n, r, i, s) {
          ...
          if (
              ...
              (a = new ct[e]()).init(
                ...
                a.rawVars
                  ...
                  : (function (e, t, n, r, i) {
                      if (
                        (Ie(e) && (e = Zn(e, i, t, n, r)),
                        !Re(e) || (e.style && e.nodeType) || Xe(e) || Be(e))
                      )
                        return Le(e) ? Zn(e, i, t, n, r) : e;
                      var s,
                        a = {};
            ...
            ((n._pt = o =
              new mr(n._pt, i, e, 0, 1, a.render, a, 0, a.priority)),
            n !== ge)
          )
            for (
        ...
        Kn = function e(t, n, r) {
          var i,
            ...
            A = t._targets,
            P = t.parent,
            O = P && "nested" === P.data ? P.vars.targets : A,
            D = "auto" === t._overwrite && !le,
            L = t.timeline;
          if (
            (L && (!k || !y) && (y = "none"),
            (t._ease = Rn(y, Se.ease)),
            (t._yEase = S ? Nn(Rn(!0 === S ? y : S, Se.ease)) : 0),
            S &&
              t._yoyo &&
              !t._repeat &&
            ...
            if (
              ((m = (d = A[0] ? mt(A[0]).harness : 0) && g[d.prop]),
              (i = At(g, at)),
              M &&
              ...
              if (
                ...
                (t._startAt._dp = 0),
                (t._startAt._sat = t),
                n < 0 && (ce || (!w && !C)) && t._startAt.revert(it),
                w && E && n <= 0 && r <= 0)
              )
              ...
              if (
                ...
                m && (a[d.prop] = m),
                Lt((t._startAt = tr.set(A, a))),
                (t._startAt._dp = 0),
                (t._startAt._sat = t),
                n < 0 &&
                  (ce ? t._startAt.revert(it) : t._startAt.render(-1, !0)),
                (t._zTime = n),
                w)
              ) {
                if (!n) return;
            ...
            for (
              t._pt = t._ptCache = 0, b = (E && je(b)) || (b && !E), s = 0;
              s < A.length;
              s++
            ) {
              if (
                ((u = (l = A[s])._gsap || ht(A)[s]._gsap),
                (t._ptLookup[s] = f = {}),
                lt[u.id] && ot.length && xt(),
                (h = O === A ? s : O.indexOf(l)),
                d &&
                  !1 !== (p = new d()).init(l, m || i, t, h, O) &&
                  ((t._pt = o =
                    new mr(t._pt, l, p.name, 0, 1, p.render, p, 0, p.priority)),
                ...
                for (a in i)
                  ct[a] && (p = Un(a, i, t, h, l, O))
                    ? p.priority && (c = 1)
                    : (f[a] = o =
                        Wn.call(t, l, a, "get", i[a], h, O, 0, g.stringFilter));
              t._op && t._op[s] && t.kill(l, t._op[s]),
                D &&
                  t._pt &&
                  (($n = t),
                  de.killTweensOf(l, f, t.globalTime(n)),
                  (v = !t.parent),
                  ($n = 0)),
                t._pt && b && (lt[u.id] = 1);
            }
        ...
        Zn = function (e, t, n, r, i) {
          return Ie(e)
            ? e.call(t, n, r, i)
            : Le(e) && ~e.indexOf("random(")
              ? fn(e)
              : e;
        },
        Jn = ft + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
        er = {};
      ...
      var tr = (function (e) {
        function t(t, n, r, i) {
          ...
          var a,
            ...
            p,
            f,
            h = (s = e.call(this, i ? n : Pt(n)) || this).vars,
            m = h.duration,
            v = h.delay,
            g = h.immediateRender,
            y = h.stagger,
            ...
            T = h.yoyoEase,
            S = n.parent || de,
            k = (Xe(t) || Be(t) ? Ne(t[0]) : "length" in n) ? [t] : sn(t);
          if (
            ((s._targets = k.length
              ? ht(k)
              : et(
            ...
            if (
              ...
              if (((c = k.length), (p = y && ln(y)), Re(y)))
                for (u in y) ~Jn.indexOf(u) && (f || (f = {}), (f[u] = y[u]));
              for (o = 0; o < c; o++)
                ((l = At(n, er)).stagger = 0),
                  T && (l.yoyoEase = T),
                  f && Et(l, f),
                  (d = k[o]),
                  (l.duration = +Zn(m, ae(s), o, d, k)),
                  (l.delay = (+Zn(v, ae(s), o, d, k) || 0) - s._delay),
                  !y &&
                    1 === c &&
                    l.delay &&
                    ((s._delay = v = l.delay), (s._start += v), (l.delay = 0)),
                  a.to(d, l, p ? p(o, d, k) : 0),
                  (a._ease = On.none);
              a.duration() ? (m = v = 0) : (s.timeline = 0);
            } else if (w) {
              Pt(Ct(a.vars.defaults, { ease: "none" })),
                (a._ease = Rn(w.ease || n.ease || "none"));
              var C,
                E,
                M,
                A = 0;
          ...
          return (
            !0 !== _ || le || (($n = ae(s)), de.killTweensOf(k), ($n = 0)),
            Ht(S, ae(s), r),
        ...
        return (
              ...
              if (
                ...
                if (((r = v), (u = this.timeline), this._repeat)) {
                  ...
                  if (
                    ...
                    v === f
                      ? ((s = this._repeat), (r = h))
                      : ((s = ~~(v / a)) && s === _t(v / a) && ((r = h), s--),
                        r > h && (r = h)),
                    (l = this._yoyo && 1 & s) &&
                      ((d = this._yEase), (r = h - r)),
                    (o = jt(this._tTime, a)),
                    r === p && !n && this._initted && s === o)
                  )
                    return (this._tTime = v), this;
                  s !== o &&
                    (u && this._yEase && zn(u, l),
                    this.vars.repeatRefresh &&
                      !l &&
                      !this._lock &&
                      this._time !== h &&
                      this._initted &&
                      ((this._lock = n = 1),
                      (this.render(_t(a * s), !0).invalidate()._lock = 0)));
                }
                if (!this._initted) {
                  if ($t(this, m ? e : r, n, t, v))
                ...
                (u &&
                  ...
                  this._onUpdate &&
                    !t &&
                    (m && Nt(this, e, 0, n), vn(this, "onUpdate")),
                  this._repeat &&
                    s !== o &&
                    this.vars.onRepeat &&
                    !t &&
                  ...
                  (v !== this._tDur && v) ||
                    this._tTime !== v ||
                    (m && !this._onUpdate && Nt(this, e, 0, !0),
                    (e || !h) &&
              ...
              !(function (e, t, n, r) {
                var i,
                  ...
                  l =
                    t < 0 ||
                    (!t &&
                      ((!e._start && Vt(e) && (e._initted || !Gt(e))) ||
                        ((e._ts < 0 || e._dp._ts < 0) && !Gt(e))))
                      ? 0
                      : 1,
                  c = e._rDelay,
                  u = 0;
                if (
                  ...
                  l !== o || ce || r || e._zTime === Ce || (!t && e._zTime))
                ) {
                  ...
                  for (
                    ...
                    i.r(l, i.d), (i = i._next);
                  t < 0 && Nt(e, t, 0, !0),
                    e._onUpdate && !n && vn(e, "onUpdate"),
                    u && e._repeat && !n && e.parent && vn(e, "onRepeat"),
                    (t >= e._tDur || t < 0) &&
                      e.ratio === l &&
                      (l && Lt(e, 1),
                      n ||
                        ce ||
                        (vn(e, l ? "onComplete" : "onReverseComplete", !0),
                        e._prom && e._prom()));
                  ...
                  for (
                    ...
                    if (!l)
                      return (
                        ...
                        Kn(e, a),
                        (Vn = 0),
                        o ? et(t + " not eligible for reset") : 1
                      );
                    p.push(l);
                  }
                for (d = p.length; d--; )
                  ((l = (c = p[d])._pt || c).s =
                    ...
                    c.e && (c.e = yt(n) + tn(c.e)),
                    c.b && (c.b = l.s + tn(c.b));
              })(this, e, t, n, r, this._ease(s / this._dur), s, i)
          ...
          (n.kill = function (e, t) {
            ...
            if (this.timeline) {
              ...
              return (
                this.timeline.killTweensOf(e, t, $n && !0 !== $n.vars.overwrite)
                  ._first || gn(this),
                this.parent &&
      ...
      gt(
        ...
        (Ke.TweenMax = Ke.TweenLite = tr),
        (Ke.TimelineLite = Ke.TimelineMax = Yn),
        (de = new Yn({
          sortChildren: !1,
          defaults: Se,
      ...
      var vr = [],
          ...
          e - _r > 2 &&
            ...
            vr.forEach(function (e) {
              var n,
                ...
                o = e.conditions;
              for (r in a)
                (n = pe.matchMedia(a[r]).matches) && (i = 1),
                  n !== o[r] && ((o[r] = n), (s = 1));
          ...
          return (
            ...
            (t.kill = function (e, t) {
              ...
              if (
                (e
                  ? (function () {
                      ...
                      for (
                        ...
                        (t = n.data[i]) instanceof Yn
                          ? "nested" !== t.data &&
                            (t.scrollTrigger && t.scrollTrigger.revert(),
                            t.kill())
                          : !(t instanceof tr) && t.revert && t.revert(e);
                ...
                for (var r = vr.length; r--; )
                  vr[r].id === this.id && vr.splice(r, 1);
            }),
            (t.revert = function (e) {
              this.kill(e || {});
            }),
          ...
          return (
            (t.add = function (e, t, n) {
              ...
              var r,
                i,
                s,
                a = new Tr(0, n || this.scope),
                o = (a.conditions = {});
              for (i in (ue && !a.selector && (a.selector = ue.selector),
        ...
        kr = {
          ...
          defaults: function (e) {
            return (
              e && e.ease && (e.ease = Rn(e.ease, Se.ease)), Mt(Se, e || {})
            );
          },
          config: function (e) {
            return Mt(Te, e || {});
          ...
          exportRoot: function (e, t) {
            ...
            var n,
              ...
              i = new Yn(e);
            for (
              i.smoothChildTiming = je(e.smoothChildTiming),
                de.remove(i),
                i._dp = 0,
          ...
          kr.registerPlugin(
            {
              ...
              render: function (e, t) {
                for (var n = t._pt; n; )
                  ce ? n.set(n.t, n.p, n.b, n) : n.r(e, n.d), (n = n._next);
              },
            },
            {
              name: "endArray",
      ...
      (tr.version = Yn.version = Mr.version = "3.12.3"),
        (me = 1),
        qe() && Pn(),
        On.Power0,
        On.Power1,
      ...
      var Ar,
        ...
        si = function e(t, n) {
          ...
          if (t in Rr && s) {
            if (((this.tfm = this.tfm || {}), "transform" === t))
              return Yr.transform.split(",").forEach(function (t) {
                return e.call(r, t, n);
              });
            if (
              (~(t = Yr[t] || t).indexOf(",")
                ...
                : (this.tfm[t] = a.x ? a[t] : Ti(i, t)),
              t === ii && (this.tfm.zOrigin = a.zOrigin),
            ...
            t in Rr && t !== ii && (t = ri),
              r.removeProperty
                ? (("ms" !== (n = t.substr(0, 2)) &&
                    ...
                    (t = "-" + t),
                  r.removeProperty(
                    "--" === n ? t : t.replace(Br, "-$1").toLowerCase(),
                  ))
                : r.removeAttribute(t);
          }
        },
        ...
        xi = function e(t, n, r, i) {
          ...
          return (
            p && g && (((o = mt(a)).time = An.time), (o.width = a[h])),
            yt(v ? (s * c) / m : s && c ? (m / s) * c : 0)
          );
        },
        Ti = function (e, t, n, r) {
          var i;
            ...
            Rr[t] && "transform" !== t
              ...
              : (!(i = e.style[t]) ||
                ...
                (i =
                  ...
                  vt(e, t) ||
                  ("opacity" === t ? 1 : 0)),
            n && !~(i + "").trim().indexOf(" ") ? xi(e, t, i, n) + n : i
          );
        },
        Si = function (e, t, n, r) {
          if (!n || "none" === n) {
            ...
            s && s !== n
              ? ((t = i), (n = s))
              : "borderColor" === t && (n = ui(e, "borderTopColor"));
          }
          var a,
            o,
            l,
            ...
            m,
            v,
            g = new mr(this._pt, e.style, t, 0, 1, cr),
            y = 0,
            _ = 0;
          if (
            ((g.b = n),
          ...
          if (t.tween && t.tween._time === t.tween._dur) {
            ...
            if ("all" === o || !0 === o) (a.cssText = ""), (r = 1);
              ...
              for (i = (o = o.split(",")).length; --i > -1; )
                (n = o[i]),
                  Rr[n] && ((r = 1), (n = "transformOrigin" === n ? ii : ri)),
                  yi(s, n);
            r &&
              (yi(s, ri),
              l &&
          ...
          return a.svg && e.getAttribute("transform")
            ...
            : (l !== Mi ||
                ...
                ((n = e.parentNode) && e.offsetParent) ||
                  ((s = 1), (r = e.nextElementSibling), Or.appendChild(e)),
                (l = Oi(e)),
                i ? (o.display = i) : yi(e, "display"),
                s &&
                  (r
                    ? n.insertBefore(e, r)
                    : n
        ...
        Li = function (e, t, n, r, i, s) {
          ...
          n
            ? u !== Mi &&
              (o = m * y - v * g) &&
              ((l = x * (-v / o) + T * (m / o) - (m * w - v * _) / o),
              (x = x * (y / o) + T * (-g / o) + (g * w - y * _) / o),
              (T = l))
            : ((x =
                (a = vi(e)).x + (~b[0].indexOf("%") ? (x / 100) * a.width : x)),
              (T =
                a.y +
                (~(b[1] || b[0]).indexOf("%") ? (T / 100) * a.height : T)),
              "xOrigin" in c || (!x && !T) || ((x -= a.x), (T -= a.y))),
            r || (!1 !== r && c.smooth)
              ? ((_ = x - d),
                (w = T - p),
                (c.xOffset = f + (_ * m + w * g) - _),
                (c.yOffset = h + (_ * v + w * y) - w))
            ...
            s &&
              (_i(s, c, "xOrigin", d, x),
              _i(s, c, "yOrigin", p, T),
              _i(s, c, "xOffset", f, c.xOffset),
              _i(s, c, "yOffset", h, c.yOffset)),
        ...
        Ii = function (e, t) {
          ...
          return (
            ...
            n.svg &&
              (n.uncache
                ? ((E = e.getBBox()),
                  (F = n.xOrigin - E.x + "px " + (n.yOrigin - E.y) + "px"),
                  (C = ""))
                : (C = !t && e.getAttribute("data-svg-origin")),
              Li(e, C || F, !!C || n.originIsAbsolute, !1 !== n.smooth, v)),
            (h = n.xOrigin || 0),
            (m = n.yOrigin || 0),
            v !== Mi &&
              ((w = v[0]),
              ...
              6 === v.length
                ? ((a = Math.sqrt(w * w + b * b)),
                  ...
                  (l = w || b ? Fr(b, w) * jr : 0),
                  (d = x || T ? Fr(x, T) * jr + l : 0) &&
                    (o *= Math.abs(Math.cos(d * qr))),
                  n.svg &&
                    ((r -= h - (h * w + m * x)), (i -= m - (h * b + m * T))))
                : ((I = v[6]),
                  (D = v[7]),
                  (A = v[8]),
                  (P = v[9]),
                  ...
                  (c = (g = Fr(I, O)) * jr),
                  g &&
                    ((C = S * (y = Math.cos(-g)) + A * (_ = Math.sin(-g))),
                    (E = k * y + P * _),
                    (M = I * y + O * _),
                    (A = S * -_ + A * y),
                    (P = k * -_ + P * y),
                  ...
                  g &&
                    ((y = Math.cos(-g)),
                    (L = T * (_ = Math.sin(-g)) + L * y),
                    (w = C = w * y - A * _),
                    (b = E = b * y - P * _),
                    (x = M = x * y - O * _)),
                  (l = (g = Fr(b, w)) * jr),
                  g &&
                    ((C = w * (y = Math.cos(g)) + b * (_ = Math.sin(g))),
                    (E = S * y + k * _),
                    (b = b * y - w * _),
                    (k = k * y - S * _),
                    (w = C),
                  ...
                  c &&
                    ...
                    ((c = l = 0), (u = 180 - u)),
                  (a = yt(Math.sqrt(w * w + b * b + x * x))),
                  (o = yt(Math.sqrt(k * k + I * I))),
                  (g = Fr(S, k)),
                  (d = Math.abs(g) > 2e-4 ? g * jr : 0),
                  (f = L ? 1 / (L < 0 ? -L : L) : 0)),
              n.svg &&
                ((C = e.getAttribute("transform")),
                (n.forceCSS =
                  e.setAttribute("transform", "") || !Pi(ui(e, ri))),
            ...
            (n.skewX = d + j),
            (n.skewY = p + j),
            (n.transformPerspective = f + R),
            (n.zOrigin =
              parseFloat(F.split(" ")[2]) || (!t && n.zOrigin) || 0) &&
              (N[ii] = Ni(F)),
            n.svg || (n.xOffset = n.yOffset = 0),
            (n.force3D = Te.force3D),
            (n.renderTransform = n.svg ? Xi : zr ? Bi : Ri),
            (n.uncache = 0),
            n
          );
        },
        ...
        Bi = function (e, t) {
          ...
          if (y && (u !== ji || c !== ji)) {
            ...
            (x = parseFloat(u) * qr),
              (b = Math.cos(x)),
              (s = zi(g, s, T * b * -y)),
              (a = zi(g, a, -Math.sin(x) * -y)),
              (o = zi(g, o, S * b * -y + y));
          }
          m !== qi && (_ += "perspective(" + m + Fi),
            (r || i) && (_ += "translate(" + r + "%, " + i + "%) "),
            (w || s !== qi || a !== qi || o !== qi) &&
              (_ +=
                o !== qi || w
            ...
            c !== ji && (_ += "rotateY(" + c + Fi),
            u !== ji && (_ += "rotateX(" + u + Fi),
            (d === ji && p === ji) || (_ += "skew(" + d + ", " + p + Fi),
            (1 === f && 1 === h) || (_ += "scale(" + f + ", " + h + Fi),
        ...
        Xi = function (e, t) {
          ...
          (p = parseFloat(p)),
            ...
            ((T && !~(u + "").indexOf("px")) ||
              (S && !~(d + "").indexOf("px"))) &&
              ((T = xi(g, "x", u, "px")), (S = xi(g, "y", d, "px"))),
            (y || _ || w || b) &&
              ((T = yt(T + y - (y * n + _ * i) + w)),
              (S = yt(S + _ - (y * r + _ * s) + b))),
            (l || c) &&
              ((a = g.getBBox()),
              (T = yt(T + (l / 100) * a.width)),
              (S = yt(S + (c / 100) * a.height))),
            (a =
              "matrix(" +
              n +
              "," +
        ...
        Hi = function (e, t, n, r, i) {
          var s,
            ...
            o = 360,
            l = Le(i),
            c = parseFloat(i) * (l && ~i.indexOf("rad") ? jr : 1) - r,
            u = r + c + "deg";
          return (
            l &&
              ("short" === (s = i.split("_")[1]) &&
              ...
              "cw" === s && c < 0
                ...
                : "ccw" === s &&
                  c > 0 &&
                  (c = ((c - 36e9) % o) - ~~(c / o) * o)),
            (e._pt = a = new mr(e._pt, t, n, r, c, Vr)),
            (a.e = u),
            (a.u = "deg"),
            e._props.push(n),
            a
        ...
        $i = function (e, t, n) {
          ...
          Rr))
            (s = u[i]) !== (a = r[i]) &&
              ...
              ((o = tn(s) !== (c = tn(a)) ? xi(n, i, s, c) : parseFloat(s)),
              (l = parseFloat(a)),
              (e._pt = new mr(e._pt, r, i, o, l - o, $r)),
              (e._pt.u = c || 0),
              e._props.push(i));
          Yi(r, u);
        };
      gt("padding,margin,Width,Radius", function (e, t) {
        var n = "Top",
          ...
          i = "Bottom",
          s = "Left",
          a = (t < 3 ? [n, r, i, s] : [n + s, n + r, i + r, i + s]).map(
            function (n) {
        ...
        Wi = {
          ...
          init: function (e, t, n, r, i) {
            var s,
              ...
              E = n.vars.startAt;
            for (d in (Dr || fi(),
            (this.styles = this.styles || li(e)),
            (w = this.styles.props),
            (this.tween = n),
            t))
              if (
                "autoRound" !== d &&
                ((a = t[d]), !ct[d] || !Un(d, t, n, r, e, i))
              )
                if (
                  ((c = typeof a),
                  (u = Ei[d]),
                  "function" === c && (c = typeof (a = a.call(n, r, e, i))),
                  "string" === c && ~a.indexOf("random(") && (a = fn(a)),
                  u)
                )
                  u(this, e, d, a, n) && (_ = 1);
                  ...
                  (s = (getComputedStyle(e).getPropertyValue(d) + "").trim()),
                    (a += ""),
                    (Cn.lastIndex = 0),
                    Cn.test(s) || ((p = tn(s)), (f = tn(a))),
                    f ? p !== f && (s = xi(e, d, s, f) + f) : p && (a += p),
                  ...
                  if (
                    (E && d in E
                      ? ((s =
                          "function" == typeof E[d]
                            ? E[d].call(n, r, e, i)
                            : E[d]),
                        Le(s) && ~s.indexOf("random(") && (s = fn(s)),
                        tn(s + "") ||
                          "auto" === s ||
                          (s += Te.units[d] || tn(Ti(e, d)) || ""),
                        "=" === (s + "").charAt(1) && (s = Ti(e, d)))
                      : (s = Ti(e, d)),
                    (l = parseFloat(s)),
                    (h =
                    ...
                    if (
                      ...
                      (this._pt = new mr(
                        ...
                        "scaleY",
                        g.scaleY,
                        (h ? wt(g.scaleY, h + o) : o) - g.scaleY || 0,
                        $r,
                      )),
                        (this._pt.u = 0),
                        k.push("scaleY", d),
                        ...
                        w.push(ii, 0, C[ii]),
                          ...
                          g.svg
                            ...
                            : ((f = parseFloat(a.split(" ")[2]) || 0) !==
                                g.zOrigin &&
                                _i(this, g, "zOrigin", g.zOrigin, f),
                              _i(this, C, d, Ni(s), Ni(a)));
                        continue;
                      }
                      if ("svgOrigin" === d) {
                        Li(e, a, 1, y, 0, this);
                  ...
                  if (
                    m ||
                    ((o || 0 === o) && (l || 0 === l) && !Hr.test(a) && d in C)
                  )
                    o || (o = 0),
                      (p = (s + "").substr((l + "").length)) !==
                        (f = tn(a) || (d in Te.units ? Te.units[d] : p)) &&
                        (l = xi(e, d, s, f)),
                      (this._pt = new mr(
                        this._pt,
                        m ? g : C,
                      ...
                      p !== f &&
                        "%" !== f &&
                        ((this._pt.b = s), (this._pt.r = Gr));
                  else if (d in C) Si.call(this, e, d, s, h ? h + a : a);
                  else if (d in e)
                    this.add(e, d, s || e[d], h ? h + a : a, r, i);
                  else if ("parseTransform" !== d) {
                    Je(d, a);
                    continue;
                  }
                  m || (d in C ? w.push(d, 0, C[d]) : w.push(d, 1, s || e[d])),
                    k.push(d);
                }
            _ && hr(this);
          },
      ...
      (Mr.utils.checkPrefix = pi),
        (Mr.core.getStyleSaver = li),
        (Gi = gt(
        ...
        (Yr[Gi[13]] = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent," + Vi),
        gt(
      ...
      var Qi,
        ...
        Ss = function (e, t) {
          var n = function n(r) {
            if (r || 0 === r) {
              ...
              (r = n.v = Math.round(r) || (os && os.iOS ? 1 : 0)),
                e(r),
                (n.cacheID = fs.cache),
                i && vs("ss", r);
            } else
              (t || fs.cache !== n.cacheID || vs("ref")) &&
                ((n.cacheID = fs.cache), (n.v = e()));
            return n.v + n.offset;
          };
        ...
        ks = {
          ...
          sc: Ss(function (e) {
            return arguments.length
              ? Ji.scrollTo(e, Cs.sc())
              : Ji.pageXOffset || es[bs] || ts[bs] || ns[bs] || 0;
          }),
        },
        Cs = {
          s: xs,
          ...
          sc: Ss(function (e) {
            return arguments.length
              ? Ji.scrollTo(ks.sc(), e)
              : Ji.pageYOffset || es[xs] || ts[xs] || ns[xs] || 0;
          }),
        },
        Es = function (e, t) {
          return (
            ((t && t._ctx && t._ctx.selector) || Qi.utils.toArray)(e)[0] ||
            ("string" == typeof e && !1 !== Qi.config().nullTargetWarn
        ...
        Ms = function (e, t) {
          ...
          return (
            (o.target = e),
            a || (o.smooth = "smooth" === Qi.getProperty(e, "scrollBehavior")),
            o
          );
        },
        As = function (e, t, n) {
        ...
        Ds = function () {
          var e, t, n, r;
          (ss = Qi.core.globals().ScrollTrigger) &&
            ss.core &&
            ((e = ss.core),
            (t = e.bridge || {}),
            (n = e._scrollers),
        ...
        Ls = function (e) {
          return (
            ...
            !Zi &&
              ...
              ((Ji = window),
              (es = document),
              (ts = es.documentElement),
              (ns = es.body),
              (as = [Ji, es, ts, ns]),
              Qi.utils.clamp,
              (cs = Qi.core.context || function () {}),
              (is = "onpointerenter" in ns ? "pointer" : "mouse"),
              (rs = Is.isTouch =
                Ji.matchMedia &&
        ...
        return (
          (e.prototype.init = function (e) {
            ...
            var t = e.tolerance,
              ...
              B = e.lockAxis,
              X = e.onLockAxis;
            (this.target = i = Es(i) || ts),
              (this.vars = e),
              u && (u = Qi.utils.toArray(u)),
              (t = t || 1e-9),
              (n = n || 0),
              (d = d || 1),
              (j = j || 1),
              ...
              (a = !1 !== a),
              s || (s = parseFloat(Ji.getComputedStyle(ns).lineHeight) || 22);
            var H,
              Y,
              $,
              V,
            ...
            (Y = K._dc =
              Qi.delayedCall(c || 0.25, function () {
              ...
              (K.enable = function (e) {
                return (
                  K.isEnabled ||
                    (_s(ie ? se : i, "scroll", Ts),
                    r.indexOf("scroll") >= 0 &&
                      _s(ie ? se : i, "scroll", _e, o, q),
                    r.indexOf("wheel") >= 0 && _s(i, "wheel", we, o, q),
                    ((r.indexOf("touch") >= 0 && rs) ||
                      r.indexOf("pointer") >= 0) &&
                      (_s(i, ls[0], me, o, q),
                      _s(se, ls[2], ve),
                      _s(se, ls[3], ve),
                      F && _s(i, "click", ce, !1, !0),
                      R && _s(i, "click", Se),
                      D && _s(se, "gesturestart", ge),
                      L && _s(se, "gestureend", ye),
                      E && _s(i, is + "enter", xe),
                      M && _s(i, is + "leave", Te),
                      A && _s(i, is + "move", be)),
                    (K.isEnabled = !0),
              ...
              (K.disable = function () {
                K.isEnabled &&
                  ...
                  }).length || ws(ie ? se : i, "scroll", Ts),
                  K.isPressed &&
                    (K._vx.reset(),
                    K._vy.reset(),
                    ws(O ? i : se, ls[1], he, !0)),
                  ws(ie ? se : i, "scroll", _e, q),
                  ws(i, "wheel", we, q),
                  ws(i, ls[0], me, q),
                  ws(se, ls[2], ve),
                  ws(se, ls[3], ve),
      ...
      var Ns,
        ...
        Sa = function (e, t, n) {
          var r =
            ja(e) && ("clamp(" === e.substr(0, 6) || e.indexOf("max") > -1);
          return (n["_" + t + "Clamp"] = r), r ? e.substr(6, e.length - 7) : e;
        },
        ka = function (e, t) {
          return !t || (ja(e) && "clamp(" === e.substr(0, 6))
            ? e
            : "clamp(" + e + ")";
        },
        Ca = function e() {
        ...
        Ra = function (e, t) {
          for (var n = 0; n < Js.length; n += 3)
            (!t || ~t.indexOf(Js[n + 1])) && e(Js[n], Js[n + 1], Js[n + 2]);
        },
        ja = function (e) {
          return "string" == typeof e;
        },
        ...
        wo = function (e, t, n, r, i, s, a, o) {
          var l = i.startColor,
            ...
            d = i.indent,
            p = i.fontWeight,
            f = js.createElement("div"),
            h = La(n) || "fixed" === gs(n, "pinType"),
          ...
          return (
            (_ += "position:" + ((m || o) && h ? "fixed;" : "absolute;")),
            (m || o || !h) &&
              (_ += (r === Cs ? Va : Ga) + ":" + (s + parseFloat(d)) + "px;"),
            a &&
              (_ +=
        ...
        ko = function () {
          (!ra || !ra.isPressed || ra.startX > Fs.clientWidth) &&
            (fs.cache++,
            ra ? ma || (ma = requestAnimationFrame(Xo)) : Xo(),
            xa || Oo("scrollStart"),
            (xa = wa()));
        },
        Co = function () {
        ...
        Eo = function () {
          fs.cache++,
            !Gs &&
              ...
              (!ia ||
                aa !== Rs.innerWidth ||
                Math.abs(Rs.innerHeight - sa) > 0.25 * Rs.innerHeight) &&
              Xs.restart(!0);
        },
        Mo = {},
        Ao = [],
        ...
        Do = [],
        Lo = function (e) {
          for (var t = 0; t < Do.length; t += 5)
            (!e || (Do[t + 4] && Do[t + 4].query === e)) &&
              ((Do[t].style.cssText = Do[t + 1]),
              Do[t].getBBox && Do[t].setAttribute("transform", Do[t + 2] || ""),
              (Do[t + 3].uncache = 1));
        },
        Io = function (e, t) {
          var n;
          for (Ks = 0; Ks < xo.length; Ks++)
            !(n = xo[Ks]) ||
              (t && n._ctx !== t) ||
        ...
        Ro = function () {
          Fs.appendChild(ua),
            (da = (!ra && ua.offsetHeight) || Rs.innerHeight),
            Fs.removeChild(ua);
        },
        jo = function (e) {
          return Hs(
        ...
        Xo = function (e) {
          if (2 === e || (!va && !pa)) {
            ...
            if (
              ...
              va || (Fo = i),
              r &&
                (xa && !Ws && n - xa > 200 && ((xa = 0), Oo("scrollEnd")),
                ($s = ba),
                (ba = n)),
              Bo < 0)
            ) {
        ...
        $o = function (e, t, n, r) {
          if (!e._gsap.swappedIn) {
            for (var i, s = Ho.length, a = t.style, o = e.style; s--; )
              a[(i = Ho[s])] = n[i];
        ...
        Go = function (e) {
          if (e) {
            var t,
              ...
              s = 0;
            for (
              (e.t._gsap || Ns.core.getCache(e.t)).uncache = 1;
              s < i;
              s += 2
            )
              (n = e[s + 1]),
                ...
                n
                  ? (r[t] = n)
                  : r[t] &&
                    r.removeProperty(t.replace(Vo, "-$1").toLowerCase());
          }
        },
        Wo = function (e) {
          for (var t = Yo.length, n = e.style, r = [], i = 0; i < t; i++)
            r.push(Yo[i], n[Yo[i]]);
          return (r.t = e), r;
        },
        Uo = { left: 0, top: 0 },
        Ko = function (e, t, n, r, i, s, a, o, l, c, u, d, p, f) {
          qa(e) && (e = e(o)),
            ja(e) &&
              "max" === e.substr(0, 3) &&
              (e = d + ("=" === e.charAt(4) ? _o("0" + e.substr(3), n) : 0));
          var h,
            m,
            v,
            g = p ? p.time() : 0;
          if ((p && p.seek(0), isNaN(e) || (e = +e), Fa(e)))
            p &&
              (e = Ns.utils.mapRange(
            ...
            (v = Es(t, o) || Fs),
              ...
              (_ = _o(x[0], y[r.d])),
              (w = _o(x[1] || "0", n)),
              (e = y[r.p] - l[r.p] - c + _ + i - w),
              a && bo(a, w, r, n - w < 20 || (a._isStart && w > 20)),
              (n -= n - w);
          }
          if ((f && ((o[f] = e || -0.001), e < 0 && (e = 0)), s)) {
            ...
            (h = "scroll" + r.d2),
              bo(
                ...
                (S && T > 20) ||
                  (!S &&
                    (u ? Math.max(Fs[h], qs[h]) : s.parentNode[h]) <= T + 1),
              ),
              u &&
                ((l = oo(a)),
                u && (s.style[r.op.p] = l[r.op.p] - r.op.m - s._offset + io));
          }
          return (
            p &&
              v &&
        ...
        Zo = function (e, t, n, r) {
          if (e.parentNode !== t) {
            var i,
              ...
              a = e.style;
            if (t === Fs) {
              for (i in ((e._stOrig = a.cssText), (s = so(e))))
                +i ||
                  Qo.test(i) ||
                  !s[i] ||
                  "string" != typeof a[i] ||
        ...
        tl = function (e, t) {
          ...
          return (
            ...
            nl.isTouch && fo(e, "touchmove", n.wheelHandler),
            i
          );
        },
        nl = (function () {
          ...
          return (
            (e.prototype.init = function (t, n) {
              if (
                ...
                var r,
                  ...
                  Y,
                  $ = (t = ao(
                    ja(t) || Fa(t) || t.nodeType ? { trigger: t } : t,
                    go,
                  )),
                  V = $.onUpdate,
                  G = $.toggleClass,
                  ...
                  fe = !Q && 0 !== Q,
                  he = Es(t.scroller || Rs),
                  me = Ns.core.getCache(he),
                  ve = La(he),
                  ge =
                    "fixed" ===
                    ("pinType" in t
                      ? t.pinType
                      : gs(he, "pinType") || (ve && "fixed")),
                  ye = [t.onEnter, t.onLeave, t.onEnterBack, t.onLeaveBack],
                  _e = fe && t.toggleActions.split(" "),
                  we = "markers" in t ? t.markers : go.markers,
                  be = ve ? 0 : parseFloat(so(he)["border" + pe.p2 + no]) || 0,
                  xe = this,
                  Te =
                    t.onRefreshInit &&
                    function () {
                  ...
                  Se = (function (e, t, n) {
                    var r = n.d,
                      i = n.d2,
                      s = n.a;
                    return (s = gs(e, "getBoundingClientRect"))
                      ? function () {
                          return s()[r];
                        }
                      : function () {
                ...
                if (
                  ...
                  (ne *= 45),
                  (xe.scroller = he),
                  (xe.scroll = ce ? ce.time.bind(ce) : Ae),
                  (a = Ae()),
                  (xe.vars = t),
                  (n = n || t.animation),
                  "refreshPriority" in t &&
                    ((ea = 1), -9999 === t.refreshPriority && (ya = xe)),
                  ...
                  n &&
                    ...
                    W || (W = n.vars.id)),
                  ae &&
                    ((Ba(ae) && !ae.push) || (ae = { snapTo: ae }),
                    "scrollBehavior" in Fs.style &&
                      Ns.set(ve ? [Fs, qs] : he, { scrollBehavior: "auto" }),
                    fs.forEach(function (e) {
                      return (
                        qa(e) &&
                        e.target === (ve ? js.scrollingElement || qs : he) &&
                        (e.smooth = !1)
                      );
                    }),
                    (s = qa(ae.snapTo)
                        ...
                        : "labelsDirectional" === ae.snapTo
                          ...
                          : !1 !== ae.directional
                            ? function (e, t) {
                                return uo(ae.snapTo)(
                                  e,
                                  wa() - Ee < 500 ? 0 : t.direction,
                                );
                              }
                            : Ns.utils.snap(ae.snapTo)),
                    (z = ae.duration || { min: 0.1, max: 2 }),
                    (z = Ba(z) ? Ys(z.min, z.max) : Ys(z, z)),
                    (R = Ns.delayedCall(ae.delay || N / 2 || 0.1, function () {
                      var e = Ae(),
                        t = wa() - Ee < 500,
                        i = r.tween;
                      if (
                  ...
                  W && (To[W] = xe),
                  (B =
                    (Z = xe.trigger = Es(Z || (!0 !== J && J))) &&
                    Z._gsap &&
                    Z._gsap.stRevert) && (B = B(xe)),
                  (J = !0 === J ? Z : Es(J)),
                  ja(G) &&
                    (G = {
                      targets: Z,
                    ...
                    (!1 === ee ||
                      ...
                      (ee =
                        !(
                          ...
                          J.parentNode &&
                          J.parentNode.style &&
                          "flex" === so(J.parentNode).display
                        ) && eo),
                    (xe.pin = J),
                    (i = Ns.core.getCache(J)).spacer
                      ? (g = i.pinState)
                      : (le &&
                          ((le = Es(le)) &&
                            !le.nodeType &&
                          ...
                          (i.spacerIsNative = !!le),
                          le && (i.spacerState = Wo(le))),
                        (i.spacer = w = le || js.createElement("div")),
                        w.classList.add("pin-spacer"),
                        W && w.classList.add("pin-spacer-" + W),
                        (i.pinState = g = Wo(J))),
                    !1 !== t.force3D && Ns.set(J, { force3D: !0 }),
                    (xe.spacer = w = i.spacer),
                    (O = so(J)),
                    (C = O[ee + pe.os2]),
                    (x = Ns.getProperty(J)),
                    (T = Ns.quickSetter(J, pe.a, io)),
                    $o(J, w, O),
                    (_ = Wo(J))),
                  we)
                ) {
                  (h = Ba(we) ? ao(we, vo) : vo),
                    (p = wo("scroller-start", W, he, pe, h, 0)),
                    (f = wo("scroller-end", W, he, pe, h, 0, p)),
                    (b = p["offset" + pe.op.d2]);
                  var Pe = Es(gs(he, "content") || he);
                  (u = this.markerStart = wo("start", W, Pe, pe, h, b, 0, ce)),
                    (d = this.markerEnd = wo("end", W, Pe, pe, h, b, 0, ce)),
                    ce && (F = Ns.quickSetter([u, d], pe.a, io)),
                    ge ||
                      (hs.length && !0 === gs(he, "fixedMarkers")) ||
                      ((Y = so((H = ve ? Fs : he)).position),
                      (H.style.position =
                        "absolute" === Y || "fixed" === Y ? Y : "relative"),
                      Ns.set([p, f], { force3D: !0 }),
                      (M = Ns.quickSetter(p, pe.a, io)),
                      (P = Ns.quickSetter(f, pe.a, io)));
                }
                if (ce) {
                  var Oe = ce.vars.onUpdate,
                    De = ce.vars.onUpdateParams;
                ...
                if (
                      ...
                      !J ||
                        ...
                        (r
                          ? (function (e, t, n) {
                              Go(n);
                              var r = e._gsap;
                              if (r.spacerIsNative) Go(r.spacerState);
                      ...
                      if (J && i && xa) fo(e, "scrollEnd", Po);
                        ...
                        var T,
                          ...
                          ie = (xe.pinnedContainer =
                            t.pinnedContainer && Es(t.pinnedContainer, xe)),
                          se = (Z && Math.max(0, xo.indexOf(xe))) || 0,
                          ae = se;
                        for (
                          we &&
                          Ba(h) &&
                          ((X = Ns.getProperty(p, pe.p)),
                          (H = Ns.getProperty(f, pe.p)));
                          ae--;

                        )
                          (D = xo[ae]).end || D.refresh(0, 1) || (Gs = xe),
                            !(L = D.pin) ||
                              (L !== Z && L !== J && L !== ie) ||
                              D.isReverted ||
                              (F || (F = []), F.unshift(D), D.revert(!0, !0)),
                            D !== xo[ae] && (se--, ae--);
                        for (
                          qa(re) && (re = re(xe)),
                            re = Sa(re, "start", xe),
                        ...
                        if (
                          ...
                          xe._endClamp &&
                            !va &&
                            ((xe._endClamp = c || -0.001),
                            (c = Math.min(c, za(he, pe)))),
                          (v = c - l || ((l -= 0.01) && 0.001)),
                          G &&
                            (Me = Ns.utils.clamp(
                              0,
                              1,
                              Ns.utils.normalize(l, c, j),
                            )),
                          (xe._pinPush = U),
                          u &&
                            W &&
                            ...
                            ie && (T[pe.p] = "-=" + Ae()),
                            Ns.set([u, d], T)),
                          !J || (fa && xe.end >= za(he, pe)))
                        ) {
                          if (Z && Ae() && !ce)
                            for (C = Z.parentNode; C && C !== Fs; )
                              C._pinOffset &&
                          ...
                          (T = so(J)),
                            ...
                            !V &&
                              ...
                              ((B = {
                                style: (B = (
                                  ve ? js.scrollingElement || qs : he
                                ).style),
                                value: B["overflow" + pe.a.toUpperCase()],
                              }),
                              ve &&
                                "scroll" !==
                                  so(Fs)["overflow" + pe.a.toUpperCase()] &&
                                (B.style["overflow" + pe.a.toUpperCase()] =
                                  "scroll")),
                            $o(J, w, T),
                            (_ = Wo(J)),
                            (C = oo(J, !0)),
                            (N = ge && Ms(he, P ? ks : Cs)()),
                            ee &&
                              (((E = [ee + pe.os2, v + U + io]).t = w),
                              (ae = ee === eo ? lo(J, pe) + v + U : 0) &&
                                (E.push(pe.d, ae + io),
                                "auto" !== w.style.flexBasis &&
                                  (w.style.flexBasis = ae + io)),
                              Go(E),
                              ie &&
                                xo.forEach(function (e) {
                                  e.pin === ie &&
                            ...
                            ge &&
                              (((O = {
                                ...
                                Math.ceil(C.width) + io),
                              (O[Ua] = O["max" + ro] =
                                Math.ceil(C.height) + io),
                              (O[to] =
                                O[to + Za] =
                                O[to + Ka] =
                                O[to + Ja] =
                            ...
                            B &&
                              (B.value
                                ? (B.style["overflow" + pe.a.toUpperCase()] =
                                    B.value)
                                : B.style.removeProperty("overflow-" + pe.a));
                        F &&
                          ...
                          (xe.end = c),
                          (a = o = va ? j : Ae()),
                          ce || va || (a < j && Ae(j), (xe.scroll.rec = 0)),
                          xe.revert(!1, !0),
                          (Ee = wa()),
                          R && ((Ce = -1), R.restart(!0)),
                          (Gs = 0),
                          n &&
                            ...
                            (n._initted || q) &&
                            n.progress() !== q &&
                            n.progress(q || 0, !0).render(n.time(), !0, !0),
                          (G || Me !== xe.progress || ce) &&
                            (n &&
                              !fe &&
                              n.totalProgress(
                                ce && l < -0.001 && !Me
                                  ? Ns.utils.normalize(l, c, 0)
                                  : Me,
                                !0,
                              ),
                            (xe.progress = G || (a - l) / v === Me ? 0 : Me)),
                          J &&
                            ee &&
                            (w._pinOffset = Math.round(xe.progress * k)),
                          I && I.invalidate(),
                          isNaN(X) ||
                            ((X -= Ns.getProperty(p, pe.p)),
                            (H -= Ns.getProperty(f, pe.p)),
                  ...
                  (xe.endAnimation = function () {
                    Xa(xe.callbackAnimation),
                      n &&
                        (I
                          ? I.progress(1)
                          : n.paused()
                            ? fe || Xa(n, xe.direction < 0, 1)
                            : Xa(n, n.reversed()));
                  }),
                  ...
                  (xe.update = function (e, t, i) {
                    if (!ce || i || e) {
                      ...
                      if (
                        ...
                        if (
                          ((f =
                            (h =
                              (s = xe.isActive = !!E && E < 1) !=
                              (!!O && O < 1)) || !!E != !!O),
                          (xe.direction = E > O ? 1 : -1),
                          (xe.progress = E),
                          f &&
                            !Gs &&
                            ((u = E && !O ? 0 : 1 === E ? 1 : 1 === O ? 2 : 3),
                            fe &&
                              ((d =
                                (!h && "none" !== _e[u + 1] && _e[u + 1]) ||
                                _e[u]),
                              (g =
                                n &&
                                ("complete" === d ||
                            ...
                            (!I || Gs || _a
                              ...
                              : (I._dp._time - I._start !== I._time &&
                                ...
                                I.resetTo
                                  ...
                                  : ((I.vars.totalProgress = E),
                                    I.invalidate().restart()))),
                          J)
                        )
                          if ((e && ee && (w.style[ee + pe.os2] = C), ge)) {
                            if (f) {
                              if (
                                ((m =
                                  !e &&
                        ...
                        ae && !r.tween && !Gs && !_a && R.restart(!0),
                          G &&
                            (h || (se && E && (E < 1 || !ha))) &&
                            Hs(G.targets).forEach(function (e) {
                          ...
                          f && !Gs
                            ? (fe &&
                              ...
                              (!h && ha) ||
                                (U && h && Ha(xe, U),
                                ye[u] && Ha(xe, ye[u]),
                                se && (1 === E ? xe.kill(!1, 1) : (ye[u] = 0)),
                                h ||
                                  (ye[(u = 1 === E ? 1 : 3)] && Ha(xe, ye[u]))),
                              ue &&
                                !s &&
                                ...
                                I
                                  ? I.progress(1)
                                  : Xa(n, "reverse" === d ? 1 : !E, 1)))
                            : fe && V && !Gs && V(xe);
                      }
                      if (P) {
                        var q = ce
                          ? (b / ce.duration()) * (ce._caScrollDist || 0)
                          : b;
                  ...
                  (xe.enable = function (t, n) {
                    xe.enabled ||
                      ...
                      fo(he, "resize", Eo),
                      ve || fo(he, "scroll", ko),
                      Te && fo(e, "refreshInit", Te),
                      !1 !== t && ((xe.progress = Me = 0), (a = o = Ce = Ae())),
                      !1 !== n && xe.refresh());
                  }),
                  ...
                  (xe.setPositions = function (e, t, n, r) {
                    ...
                    xe.refresh(
                      ...
                      !1,
                      {
                        start: ka(e, n && !!xe._startClamp),
                        end: ka(t, n && !!xe._endClamp),
                      },
                      r,
                    ),
                      xe.update();
                  ...
                  (xe.adjustPinSpacing = function (e) {
                    if (E && e) {
                      ...
                      (E[t] = parseFloat(E[t]) + e + io),
                        (E[1] = parseFloat(E[1]) + e + io),
                        Go(E);
                    }
                  }),
                  (xe.disable = function (t, n) {
                    if (
                      ...
                      (j = 0),
                      i && (i.uncache = 1),
                      Te && ho(e, "refreshInit", Te),
                      R &&
                        (R.pause(), r.tween && r.tween.kill() && (r.tween = 0)),
                      !ve)
                    ) {
                      for (var s = xo.length; s--; )
                        if (xo[s].scroller === he && xo[s] !== xe) return;
            ...
            (e.disable = function (e, t) {
              (Ta = 0),
                ...
                ho(js, "scroll", ko),
                clearInterval(Vs),
                ho(js, "touchcancel", Aa),
                ho(Fs, "touchstart", Aa),
                po(ho, js, "pointerdown,touchstart,mousedown", Ea),
                po(ho, js, "pointerup,touchend,mouseup", Ma),
                Xs.kill(),
                Ra(ho);
              for (var n = 0; n < fs.length; n += 3)
                mo(ho, fs[n], fs[n + 1]), mo(ho, fs[n], fs[n + 2]);
            }),
            (e.enable = function () {
              if (
                ((Rs = window),
                (js = document),
                (qs = js.documentElement),
                (Fs = js.body),
                Ns &&
                  ((Hs = Ns.utils.toArray),
                  (Ys = Ns.utils.clamp),
                  (la = Ns.core.context || Aa),
                  (ta = Ns.core.suppressOverwrites || Aa),
                  (ca = Rs.history.scrollRestoration || "auto"),
                  (Fo = Rs.pageYOffset),
                  Ns.core.globals("ScrollTrigger", e),
                  Fs))
              ) {
                (Ta = 1),
                ...
                for (
                  s.revert ||
                    ...
                    t = oo(Fs),
                    Cs.m = Math.round(t.top + Cs.sc()) || 0,
                    ks.m = Math.round(t.left + ks.sc()) || 0,
                    i
                      ? (r.borderTopStyle = i)
                      : r.removeProperty("border-top-style"),
                    Vs = setInterval(So, 250),
                    Ns.delayedCall(0.5, function () {
                      return (_a = 0);
                    }),
                    fo(js, "touchcancel", Aa),
                    fo(Fs, "touchstart", Aa),
                    po(fo, js, "pointerdown,touchstart,mousedown", Ea),
                    po(fo, js, "pointerup,touchend,mouseup", Ma),
                    Us = Ns.utils.checkPrefix("transform"),
                    Yo.push(Us),
                    zs = wa(),
                    Xs = Ns.delayedCall(0.2, qo).pause(),
                    Js = [
                      js,
                      "visibilitychange",
                      function () {
            ...
            (e.config = function (t) {
              ...
              (n && clearInterval(Vs)) || ((Vs = n) && setInterval(So, n)),
                "ignoreMobileResize" in t &&
                  (ia = 1 === e.isTouch && t.ignoreMobileResize),
                "autoRefreshEvents" in t &&
                  (Ra(ho) || Ra(fo, t.autoRefreshEvents || "none"),
                  (na = -1 === (t.autoRefreshEvents + "").indexOf("resize")));
            }),
            (e.scrollerProxy = function (e, t) {
              var n = Es(e),
                ...
                i = La(n);
              ~r && fs.splice(r, i ? 6 : 2),
                t && (i ? hs.unshift(Rs, t, Fs, t, qs, t) : hs.unshift(n, t));
            }),
            ...
            (e.isInViewport = function (e, t, n) {
              var r = (ja(e) ? Es(e) : e).getBoundingClientRect(),
                i = r[n ? Wa : Ua] * t || 0;
              return n
                ? r.right - i > 0 && r.left + i < Rs.innerWidth
                : r.bottom - i > 0 && r.top + i < Rs.innerHeight;
            }),
                  ...
                  null == t
                    ...
                    : t in yo
                      ...
                      : ~t.indexOf("%")
                        ...
                        : parseFloat(t) || 0;
              return n
                ? (r.left + s) / Rs.innerWidth
                : (r.top + s) / Rs.innerHeight;
            }),
      ...
      (nl.version = "3.12.3"),
        ...
        (nl.clearScrollMemory = No),
        (nl.maxScroll = function (e, t) {
          return za(e, t ? ks : Cs);
        }),
        ...
        (nl.snapDirectional = uo),
        (nl.addEventListener = function (e, t) {
          var n = Mo[e] || (Mo[e] = []);
          ~n.indexOf(t) || n.push(t);
        }),
        ...
        (nl.batch = function (e, t) {
          ...
          for (n in t)
            i[n] =
              "on" === n.substr(0, 2) && qa(t[n]) && "onRefreshInit" !== n
                ? o(0, t[n])
                : t[n];
          return (
            qa(a) &&
              ((a = a()),
              fo(nl, "refresh", function () {
                return (a = t.batchMax());
              })),
            Hs(e).forEach(function (e) {
              var t = {};
      ...
      var rl,
          ...
          if (!a._isScrollT || o - a._isScrollT > 2e3) {
            for (
              ...
              ((s.scrollHeight <= s.clientHeight &&
                ...
                (!al[(t = so(s)).overflowY] && !al[t.overflowX]));
        ...
        cl = /(input|label|select|textarea)/i,
        ul = function (e) {
            ...
            e instanceof Is
              ...
              : (function (e) {
                  ...
                  var t,
                    ...
                    f = c.onRelease,
                    h = Es(e.target) || qs,
                    m = Ns.core.globals().ScrollSmoother,
                    v = m && m.get(),
                    g =
                      oa &&
                      ((e.content && Es(e.content)) ||
                        (v && !1 !== e.content && !v.smooth() && v.content())),
                    y = Ms(h, Cs),
                    _ = Ms(h, ks),
                    w = 1,
                    b =
                      (Is.isTouch && Rs.visualViewport
                        ? Rs.visualViewport.scale * Rs.visualViewport.width
                        : Rs.outerWidth) / Rs.innerWidth,
                    x = 0,
                    T = qa(d)
                      ? function () {
                          return d(t);
                    ...
                    A = function () {
                      (g._gsap.y = Pa(parseFloat(g._gsap.y) + y.offset) + "px"),
                        (g.style.transform =
                  ...
                  return (
                    ...
                    (e.onPress = function () {
                      ...
                      var e = w;
                      (w = Pa(
                        ((Rs.visualViewport && Rs.visualViewport.scale) || 1) /
                          b,
                      )),
                        s.pause(),
                        e !== w && sl(h, w > 1.01 || (!u && "x")),
                      ...
                      function (e, t) {
                        if ((y.offset && A(), t)) {
                          ...
                          u &&
                            ...
                            ((oa && s.vars.scrollY >= n) || r >= n - 1) &&
                              Ns.to({}, { onUpdate: P, duration: a });
                        } else l.restart(!0);
                        f && f(e);
                      }),
                    (e.onWheel = function () {
                    ...
                    (e.onDisable = function () {
                      sl(h, !0),
                        ho(Rs, "resize", P),
                        nl.removeEventListener("refresh", P),
                        S.kill();
                    }),
      ...
      var dl,
        ...
        Tl = function (e, t) {
          var n = "x" === t ? "Width" : "Height",
            r = "scroll" + n,
            i = "client" + n;
          return e === fl || e === hl || e === ml
            ? Math.max(hl[r], ml[r]) - (fl["inner" + n] || hl[i] || ml[i])
            : e[r] - e["offset" + n];
        },
        Sl = function (e, t) {
        ...
        kl = function (e, t) {
          if (!(e = vl(e)[0]) || !e.getBoundingClientRect)
            return (
          ...
          var n = e.getBoundingClientRect(),
            ...
            i = r
              ? {
                  top:
                    hl.clientTop -
                    (fl.pageYOffset || hl.scrollTop || ml.scrollTop || 0),
                  left:
                    hl.clientLeft -
                    (fl.pageXOffset || hl.scrollLeft || ml.scrollLeft || 0),
                }
        ...
        El = function () {
          (dl = wl()),
            _l() &&
              ...
              ((fl = window),
              (ml = document.body),
              (hl = document.documentElement),
              (vl = dl.utils.toArray),
              dl.config({ autoKillThreshold: 7 }),
              (gl = dl.config()),
              (pl = 1));
        },
        Ml = {
          ...
          init: function (e, t, n, r, i) {
            pl || El();
            var s = this,
              a = dl.getProperty(e, "scrollSnapType");
            (s.isWin = e === fl),
              (s.target = e),
              (s.tween = n),
              (t = (function (e, t, n, r) {
                if ((xl(e) && (e = e(t, n, r)), "object" != typeof e))
                  return bl(e) && "max" !== e && "=" !== e.charAt(1)
                    ? { x: e, y: e }
                    : { y: e };
                ...
                var i,
                  s = {};
                for (i in e)
                  s[i] = "onAutoKill" !== i && xl(e[i]) ? e[i](t, n, r) : e[i];
                return s;
              })(t, r, e, i)),
              (s.vars = t),
              ...
              (s.x = s.xPrev = s.getX()),
              (s.y = s.yPrev = s.getY()),
              yl || (yl = dl.core.globals().ScrollTrigger),
              "smooth" === dl.getProperty(e, "scrollBehavior") &&
                dl.set(e, { scrollBehavior: "auto" }),
              a &&
                "none" !== a &&
                ((s.snap = 1),
          ...
          render: function (e, t) {
            ...
            (n = f || !t.skipX ? t.getX() : d),
              ...
              f
                ? fl.scrollTo(t.skipX ? n : t.x, t.skipY ? r : t.y)
      ...
      (Ml.max = Tl),
        (Ml.getOffset = kl),
        (Ml.buildGetter = Sl),
        wl() && dl.registerPlugin(Ml),
        Ui.registerPlugin(nl, Ml);
      var Al = (function () {
      ...
      t()(document).ready(function () {
        ...
        let n = "0",
          r = new Map();
        const i = t()('.rigs-design__tab-info[data-rig-design="0"]').css(
          "height",
        );
        t()(".rigs-design__tabs-display").css("height", `${Pl(i)}rem`),
          e.forEach((e, i) => {
            const s = e.getAttribute("data-rig-design");
            r.set(e, t()(`.rigs-design__tab-info[data-rig-design="${s}"]`)),
              e.addEventListener("click", (i) => {
                ((e, i) => {
                  t()(
                    `.rigs-design__tab-item[data-rig-design="${n}"]`,
                  )[0].classList.remove("active"),
                    t()(
                      `.rigs-design__tab-info[data-rig-design="${n}"]`,
                    )[0].classList.remove("active"),
                    e.classList.add("active");
                  const s = r.get(e);
                  s[0].classList.add("active");
                  const a = s.css("height");
                  t()(".rigs-design__tabs-display").css(
                    "height",
                    `${Pl(a)}rem`,
                  ),
                    (n = i);
          ...
          t()(window).resize(function () {
            !(function () {
              if (screen.width < 769) {
                if (
                  "desktop" !=
                  t()(".rigs-design__tabs-display").data("platform")
                )
                  return;
                ...
                if (
                  "mobile" != t()(".rigs-design__tabs-display").data("platform")
                )
                  return;
        ...
        t()(document).ready(function () {
          ...
          let e;
          document.querySelector(".land-rigs"),
            t()(".land-rigs").data("platform") ||
              (screen.width < 769
                ? t()(".land-rigs").data("platform", "mobile")
                : t()(".land-rigs").data("platform", "desktop"));
          const n = Ui.utils.toArray(".land-rigs__item-text").length,
            r = Ui.timeline({
              scrollTrigger: {
                trigger: ".land-rigs",
                pin: !0,
          ...
          Ui.registerPlugin(nl),
            Ui.set(".land-rigs__info-text-wrapper", { autoAlpha: 1 });
          ...
          var o = a.slice(1);
          Ui.set(a, { autoAlpha: 0 }),
            Ui.set(a[0], { autoAlpha: 1 }),
            Ui.utils.toArray("land-rigs__item-text p").slice(1);
          ...
          Ui.set(l, { visibility: "hidden" }),
            s.forEach((e, t) => {
              ...
              }).to(e, { yPercent: 0, duration: 0.6, ease: "power3.inOut" });
            }),
            s.forEach((e, t) => {
              Ui.timeline({
                scrollTrigger: {
                ...
                onStart: () => {
                  document
                    .querySelectorAll(".land-rigs__item-text.slider-slide")
                    .forEach((section) =>
            ...
            screen.width > 769
              ? (nl.refresh(),
                (e = new ee(".land-rigs__info-slider", {
                  modules: [te],
                  slidesPerView: 1,
                  speed: 1e3,
                  direction: "vertical",
            ...
            t()(".land-rigs__slide-more-btn").click(function (e) {
              const n = t()(this)
                .closest(".land-rigs__slide-text")
                .children(".land-rigs__info-list");
        ...
        t()(document).ready(function () {
          ...
          mm.add("(min-width: 768px)", () => {
            ...
            Ui.registerPlugin(nl),
              Ui.set(".well-cem__display", { autoAlpha: 1 });
            var n = Ui.utils.toArray(".well-cem__item");
            Ui.set(n[0], { position: "fixed" });
            var r = n.slice(1);
            Ui.set(r, { position: "absolute", yPercent: 100 }),
              Ui.utils.toArray("well-cem__item p").slice(1);
            var i = Ui.utils.toArray(".trigger");
            document
              .querySelector(".well-cem__item.swiper-slide")
              .classList.add("_is-active");
            Ui.set(i, { height: 1e3 }),
              Ui.set(i, { visibility: "hidden" }),
              r.forEach((e, t) => {
                Ui.timeline({
                  scrollTrigger: {
                    trigger: i[t],
              ...
              r.forEach((e, t) => {
                Ui.timeline({
                  ...
                  onStart: () => {
                    document
                      .querySelectorAll(".well-cem__item.swiper-slide")
                      .forEach((section) =>
                        section.classList.remove("_is-active"),
                      );
              ...
              t()(".well-cem").data("platform") ||
                (screen.width < 769
                  ? t()(".well-cem").data("platform", "mobile")
                  : t()(".well-cem").data("platform", "desktop")),
              screen.width > 769
                ? (Ui.set(i, { height: 1e3 }), nl.refresh())
                : (Ui.set(i, { height: 500 }), nl.refresh()),
              t()(window).resize(function () {
                !(function () {
                  if (screen.width < 769) {
            ...
            return () => {
              new ee(".well-cem__swiper", {
                modules: [ne],
                slidesPerView: 1,
                autoHeight: true,
                navigation: {
                  nextEl: ".well-cem .land-rigs__swiper-btn-next",
                  prevEl: ".well-cem .land-rigs__swiper-btn-prev",
                },
                spaceBetween: 30,
              });
            };
      ...
      t()(document).ready(function () {
        ...
        t()(".mpd-advan__tabs-display").css("height", `${Dl(i)}rem`),
          e.forEach((e, i) => {
            const s = e.getAttribute("data-mpd-advan");
            r.set(e, t()(`.mpd-advan__tab-info[data-mpd-advan="${s}"]`)),
              e.addEventListener("click", (i) => {
                ((e, i) => {
                  t()(
                    `.mpd-advan__tab-item[data-mpd-advan="${n}"]`,
                  )[0].classList.remove("active"),
                    t()(
                      `.mpd-advan__tab-info[data-mpd-advan="${n}"]`,
                    )[0].classList.remove("active"),
                    e.classList.add("active");
                  const s = r.get(e);
                  s[0].classList.add("active");
                  const a = s.css("height");
                  t()(".mpd-advan__tabs-display").css("height", `${Dl(a)}rem`),
                    (n = i);
                })(e, s);
              });
          }),
          t()(".mpd-advan__tabs-display").data("platform") ||
            (screen.width < 769
          ...
          t()(window).resize(function () {
            !(function () {
              if (screen.width < 769) {
                if (
                  "desktop" != t()(".mpd-advan__tabs-display").data("platform")
                )
                  return;
                t()(".mpd-advan__tabs-display").data("platform", "mobile");
                const e = t()('.mpd-advan__tab-info[data-mpd-advan="0"]').css(
                  "height",
                );
                t()(".mpd-advan__tabs-display").css("height", `${Dl(e)}rem`);
              } else {
                if (
                  "mobile" != t()(".mpd-advan__tabs-display").data("platform")
                )
                  return;
                t()(".mpd-advan__tabs-display").data("platform", "desktop");
                const e = t()(
        ...
        t()(document).ready(function () {
          document.querySelector(".mpd-advan") &&
            t()(".mpd-advan__item-title").click(function (e) {
              e.preventDefault(),
                t()(this).hasClass("active")
                  ? (t()(this).removeClass("active"),
                    t()(this).siblings(".mpd-advan__item-info").slideUp(400))
                  : (t()(".mpd-advan__item-title").removeClass("active"),
                    t()(this).addClass("active"),
                    t()(".mpd-advan__item-info").slideUp(400),
                    t()(this).siblings(".mpd-advan__item-info").slideDown(400));
            });
        }),
        ...
        t()(document).ready(function () {
          ...
          let e;
          t()(".history__swiper").data("platform") ||
            (screen.width < 769
              ? t()(".history__swiper").data("platform", "mobile")
              : t()(".history__swiper").data("platform", "desktop")),
            (e =
              screen.width > 769
                ? new ee(".history__swiper", {
                    modules: [ne],
                    slidesPerView: 2.25,
                    speed: 600,
                    navigation: {
            ...
            t()(window).resize(function () {
              !(function () {
                if (screen.width < 769) {
                  if ("desktop" != t()(".history__swiper").data("platform"))
                    return;
                  t()(".history__swiper").data("platform", "mobile"),
                    e.destroy(),
                    (e = new ee(".history__swiper", {
                      modules: [ne],
                      slidesPerView: 1.1,
                      speed: 400,
                      navigation: {
                  ...
                  if ("mobile" != t()(".history__swiper").data("platform"))
                    return;
                  t()(".history__swiper").data("platform", "desktop"),
                    e.destroy(),
                    (e = new ee(".history__swiper", {
        ...
        t()(document).ready(function () {
          document.querySelector(".about-adv") &&
            (t()(".about-adv__item-top").click(function (e) {
              e.preventDefault(),
                t()(this).hasClass("active")
                  ? (t()(this).removeClass("active"),
                    t()(this).siblings(".about-adv__item-info").slideUp(400))
                  : (t()(".about-adv__item-top").removeClass("active"),
                    t()(this).addClass("active"),
                    t()(".about-adv__item-info").slideUp(400),
                    t()(this).siblings(".about-adv__item-info").slideDown(400));
            }),
            t()(".about-adv__item-view-all").click(function () {
              t()(this).hasClass("hide")
                ? (t()(this)
                    .siblings(".about-adv__item-info-more")
                    .removeClass("show"),
                  t()(this).removeClass("hide"),
                  t()(this).html("View all"))
                : (t()(this)
        ...
        t()(document).ready(function () {
          ...
          let e;
          let licensesModalSwiper;
          t()(".licenses__swiper").data("platform") ||
            (screen.width < 769
              ? t()(".licenses__swiper").data("platform", "mobile")
              : t()(".licenses__swiper").data("platform", "desktop")),
            (licensesModalSwiper = new ee(".licenses-modal__swiper", {
              modules: [ne],
              speed: 500,
              spaceBetween: 30,
              navigation: {
            ...
            (e = new ee(".licenses__swiper", {
              modules: [ne],
              slidesPerView: window.innerWidth > 769 ? 3 : 1.4,
              speed: 500,
            ...
            e.on("slideChange", function () {
              licensesModalSwiper.slideTo(e.realIndex);
            }),
            licensesModalSwiper.on("slideChange", function () {
              e.slideTo(licensesModalSwiper.realIndex);
            }),
            t()(window).resize(function () {
              !(function () {
                if (screen.width < 769) {
                  if ("desktop" != t()(".licenses__swiper").data("platform"))
                    return;
                  t()(".licenses__swiper").data("platform", "mobile"),
                    e.destroy(),
                    (e = new ee(".licenses__swiper", {
                  ...
                  if ("mobile" != t()(".licenses__swiper").data("platform"))
                    return;
                  t()(".licenses__swiper").data("platform", "desktop"),
                    e.destroy(),
                    (e = new ee(".licenses__swiper", {
        ...
        t()(document).ready(function () {
          ...
          let e;
          t()(".caring__swiper").data("platform") ||
            (screen.width < 769
              ? t()(".caring__swiper").data("platform", "mobile")
              : t()(".caring__swiper").data("platform", "desktop")),
            screen.width < 769 &&
              (e = new ee(".caring__swiper", {
                modules: [ne],
                slidesPerView: 1,
                speed: 400,
                navigation: {
            ...
            t()(window).resize(function () {
              !(function () {
                if (screen.width < 769) {
                  if ("desktop" != t()(".caring__swiper").data("platform"))
                    return;
                  t()(".caring__swiper").data("platform", "mobile"),
                    e && e.destroy(),
                    (e = new ee(".caring__swiper", {
                  ...
                  if ("mobile" != t()(".caring__swiper").data("platform"))
                    return;
                  t()(".caring__swiper").data("platform", "desktop"),
                    e.destroy();
                }
        ...
        t()(document).ready(function () {
          document.querySelector(".vacancies") &&
            (t()(".vacancies__filter-fieldset").click(function (e) {
              if (e.target.classList.contains("vacancies__filter-input")) {
                const n = e.target.getAttribute("id"),
                  r = e.target.getAttribute("value"),
                  m = e.target.getAttribute("data-name");
                if (e.target.checked) {
                  t()(".vacancies__filter-box")
                    .find(`.vacancies__filter-input#${n}`)
                    .prop("checked", !0),
                    t()(".modal-filter")
                      .find(`.vacancies__filter-input#${n}`)
                      .prop("checked", !0),
                    t()(".modal-filter")
                      .find(`.vacancies__form-label#${n}`)
                      .addClass("active");
                  ...
                  t()(".vacancies__filter-box")
                    ...
                    t()(".modal-filter")
                      .find(`.vacancies__form-label#${n}`)
                      .removeClass("active"),
                    t()(".vacancies__filter-result")
                      .find(`.vacancies__filter-result-item#${n}`)
                      .remove();
              }
            }),
            t()(".vacancies__filter-result").click(function (e) {
              if (e.target.classList.contains("vacancies__filter-close")) {
                ...
                t()(".modal-filter")
                  .find(`.vacancies__form-label#${n}`)
                  .removeClass("active"),
                  t()(`.vacancies__filter-result-item#${n}`).remove(),
                  t()(`.vacancies__filter-input#${n}`).prop("checked", !1);
              }
            }),
            t()(".vacancies__filter-legend").click(function (e) {
              const n = t()(this).siblings(".vacancies__filter-second");
              t()(this).hasClass("active")
                ? (n.slideUp(300), t()(this).removeClass("active"))
                : (t()(".vacancies__filter-legend").removeClass("active"),
                  t()(".vacancies__filter-second").slideUp(300),
                  n.slideDown(300),
                  t()(this).addClass("active"));
            }),
            t()(".vacancies__filter-title").click(function (e) {
              ...
              screen.width < 768
                ? (t()(".modal-filter").addClass("active"),
                  t()(document.body).css("overflow", "hidden"))
                : t()(".vacancies__filter-box").hasClass("active")
                  ? (n.slideUp(300),
                    t()(".vacancies__filter-box").removeClass("active"))
                  : (n.slideDown(300),
                    t()(".vacancies__filter-box").addClass("active"));
            }),
            t()(".modal-filter")
              .find(".modal__close")
              .click(function () {
                t()(document.body).css("overflow", "auto"),
                  t()(".modal-filter").removeClass("active");
              }),
            ...
            document.addEventListener("click", (e) => {
              screen.width < 768 ||
                (0 === t()(".vacancies__filter-box").find(e.target).length &&
                  (t()(".vacancies__filter-box").removeClass("active"),
                  t()(".vacancies__filter-drop").slideUp(300)));
            }),
            t()(".vacancies__display").click(function (e) {
              if (!e.target.classList.contains("vacancies__item-view-all"))
                return;
              const t = e.target.parentElement,
                n = e.target;
              t.classList.contains("show")
                ? (t.classList.remove("show"), (n.textContent = "View all"))
                : (t.classList.add("show"), (n.textContent = "Hide"));
            }));
        });
    })();
})();
