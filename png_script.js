    ...
    (() => {
      ...
      t()(document).ready(function () {
        ...
        t()(document).ready(function () {
          ...
          const e = document.querySelectorAll(".plan__graph"),
            t = document.querySelectorAll(".plan__graph-percent"),
            n = document.querySelectorAll(".plan__circle"),
            r = new IntersectionObserver(
              function (e) {
                e.forEach((e) => {
                  e.isIntersecting &&
                    (t[0].classList.contains("done") ||
                      t.forEach((e) => {
                        !(function (e) {
                          let t = 0;
                          const n = Number(e.getAttribute("data-dev-number")),
                            r = Math.round(3e3 / (10 * n));
                          let i = 0;
                          for (let s = 0; s < 10 * n; s++)
                            setTimeout(() => {
                              (t += 0.1),
                                (e.textContent = `${t.toFixed(1).toString().replace(".", ",")}%`);
                            }, i),
                              (i += r);
                        })(e),
