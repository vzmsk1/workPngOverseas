...
document.addEventListener('DOMContentLoaded', function () {
	...
	if (document.querySelector('#login')) setPasswordView();
...
function validateFeedbackForm() {
	...
	const comment = $('.feedback__comment-block').children('.form__input');
	const commentMsg = $('.feedback__comment-block').children('.form__error-msg');
	const commentVal = validationInputQuestion(
		comment,
		commentMsg,
		validateComment,
	);
...
function loginValidation() {
	const email = $('.modal-form__email').children('.form__input');
	const emailMsg = $('.modal-form__email').children('.form__error-msg');
	const emailVal = validationInputQuestion(email, emailMsg, validateEmail);

	const password = $('.modal-form__password').children('.form__input');
	const passwordMsg = $('.modal-form__password').children('.form__error-msg');
	const passwordVal = validationInputQuestion(
		password,
		passwordMsg,
		validatePassword,
	);
...
//toggle inputType for password
function setPasswordView() {
	const passwordInput = $('.modal-form__password').find('.form__input');
	const passwordIcon = $('.modal-form__password').find(
...
function validateResumeForm() {
	...
	const resume = $('.feedback__resume-block').find('.form__input_resume');
	const resumeMsg = $('.feedback__resume-block').children('.form__error-msg');
	const resumeVal = validationInputQuestion(
		resume,
		resumeMsg,
		validationFileInput,
	);
...
document.addEventListener('DOMContentLoaded', function () {
	...
	$('.form__code-list').click(function (e) {
		if (!e.target.classList.contains('form__code-list')) {
			...
			const code = target.classList.contains('form__code-item')
